...
//the SD start is delayed, because otherwise the serial cannot answer fast enough to make contact with the host software.
    ...
    lastnr=0;
//power to SD reader
#if defined (A) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (B) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (C) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (D) && (SDPOWER > -1 && defined (SDSUPPORT) )
    SET_OUTPUT(SDPOWER);
    WRITE(SDPOWER,HIGH);
#endif
//SDPOWER
