#if defined (upstream) && !defined (LANGUAGE_H) || defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && !defined (LANGUAGE_H)
    #define LANGUAGE_H
#endif
#if defined (upstream) && !defined (LANGUAGE_H)
    #define LANGUAGE_CONCAT(M)       #M
#endif
#if defined (mattschUpstream) && !defined (LANGUAGE_H)
    // NOTE: IF YOU CHANGE THIS FILE / MERGE THIS FILE WITH CHANGES
#endif
#if defined (upstream) && !defined (LANGUAGE_H)
    #define GENERATE_LANGUAGE_INCLUDE(M)  LANGUAGE_CONCAT(language_##M.h)
#endif
#if defined (upstream) && !defined (LANGUAGE_H) || defined (mattsch) && !defined (LANGUAGE_H)
...
#endif
#if defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && !defined (LANGUAGE_H)
    ...
    // ca Catalan
#endif
#if defined (mattschUpstream) && (!defined (LANGUAGE_CHOICE) && !defined (LANGUAGE_H) )
    ...
    // eu Basque-Euskera
#endif
#if defined (upstream) && (!defined (LANGUAGE_INCLUDE) && !defined (LANGUAGE_H) )
    // pick your language from the list above
#endif
#if defined (mattsch) && (!defined (LANGUAGE_CHOICE) && !defined (LANGUAGE_H) )
    #define LANGUAGE_CHOICE en
#endif
#if defined (upstream) && (!defined (LANGUAGE_INCLUDE) && !defined (LANGUAGE_H) )
    #define LANGUAGE_INCLUDE GENERATE_LANGUAGE_INCLUDE(en)
#endif
#if defined (mattsch) && (!defined (LANGUAGE_CHOICE) && !defined (LANGUAGE_H) ) || defined (mattschUpstream) && (!defined (LANGUAGE_CHOICE) && !defined (LANGUAGE_H) )

    // Pick your language from the list above
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE >= 1 && !defined (LANGUAGE_H) )
    #error "Languages now uses ISO language codes instead of numbers."
#endif
#if defined (upstream) && !defined (LANGUAGE_H) || defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && !defined (LANGUAGE_H)
    #define PROTOCOL_VERSION "1.0"
#endif
#if defined (upstream) && ((MB(ULTIMAKER)|| MB(ULTIMAKER_OLD)|| MB(ULTIMAIN_2) && )!defined (LANGUAGE_H) ) || defined (mattsch) && ((MB(ULTIMAKER)|| MB(ULTIMAKER_OLD)|| MB(ULTIMAIN_2) && )!defined (LANGUAGE_H) ) || defined (mattschUpstream) && ((MOTHERBOARD == 7 || MOTHERBOARD == 71 || MOTHERBOARD == 72 && )!defined (LANGUAGE_H) )
    #define MACHINE_NAME "Ultimaker"
    #define FIRMWARE_URL "http://firmware.ultimaker.com"
#endif
#if defined (upstream) && (MB(RUMBA) && !defined (LANGUAGE_H) ) || defined (mattsch) && (MB(RUMBA) && !defined (LANGUAGE_H) ) || defined (mattschUpstream) && (MOTHERBOARD == 80 && !defined (LANGUAGE_H) )
    #define MACHINE_NAME "Rumba"
#endif
#if defined (upstream) && (MB(RUMBA) && !defined (LANGUAGE_H) )
    #define FIRMWARE_URL "https://github.com/MarlinFirmware/Marlin"
#endif
#if defined (mattsch) && (MB(RUMBA) && !defined (LANGUAGE_H) ) || defined (mattschUpstream) && (MOTHERBOARD == 80 && !defined (LANGUAGE_H) )

    #define FIRMWARE_URL "https://github.com/ErikZalm/Marlin/"
#endif
#if defined (upstream) && (MB(3DRAG) && !defined (LANGUAGE_H) ) || defined (mattsch) && (MB(3DRAG) && !defined (LANGUAGE_H) ) || defined (mattschUpstream) && (!defined (LANGUAGE_H) && MOTHERBOARD == 77 )
    #define MACHINE_NAME "3Drag"
    #define FIRMWARE_URL "http://3dprint.elettronicain.it/"
#endif
#if defined (upstream) && (MB(5DPRINT) && !defined (LANGUAGE_H) ) || defined (mattsch) && (MB(5DPRINT) && !defined (LANGUAGE_H) )

    #define MACHINE_NAME "Makibox"
#endif
#if defined (upstream) && (MB(5DPRINT) && !defined (LANGUAGE_H) )
    #define FIRMWARE_URL "https://github.com/MarlinFirmware/Marlin"
#endif
#if defined (mattsch) && (MB(5DPRINT) && !defined (LANGUAGE_H) )
    #define FIRMWARE_URL "https://github.com/ErikZalm/Marlin/"
#endif
#if defined (upstream) && (MB(SAV_MKI) && !defined (LANGUAGE_H) )
    #define MACHINE_NAME "SAV MkI"
    #define FIRMWARE_URL "https://github.com/fmalpartida/Marlin/tree/SAV-MkI-config"
#endif
#if defined (upstream) && (!MB(SAV_MKI) && !defined (LANGUAGE_H) && defined (CUSTOM_MENDEL_NAME) ) || defined (mattsch) && (!defined (LANGUAGE_H) && !MB(5DPRINT) && defined (CUSTOM_MENDEL_NAME) ) || defined (mattschUpstream) && (!MOTHERBOARD == 77 && !defined (LANGUAGE_H) && defined (CUSTOM_MENDEL_NAME) )
    #define MACHINE_NAME CUSTOM_MENDEL_NAME
#endif
#if defined (upstream) && (!MB(SAV_MKI) && !defined (CUSTOM_MENDEL_NAME) && !defined (LANGUAGE_H) ) || defined (mattsch) && (!defined (CUSTOM_MENDEL_NAME) && !defined (LANGUAGE_H) && !MB(5DPRINT) ) || defined (mattschUpstream) && (!MOTHERBOARD == 77 && !defined (CUSTOM_MENDEL_NAME) && !defined (LANGUAGE_H) )
    #define MACHINE_NAME "Mendel"
#endif
#if defined (upstream) && (!MB(SAV_MKI) && !defined (LANGUAGE_H) ) || defined (mattsch) && (!defined (LANGUAGE_H) && !MB(5DPRINT) ) || defined (mattschUpstream) && (!MOTHERBOARD == 77 && !defined (LANGUAGE_H) )
    // Default firmware set to Mendel
#endif
#if defined (upstream) && (!MB(SAV_MKI) && !defined (LANGUAGE_H) )
    #define FIRMWARE_URL "https://github.com/MarlinFirmware/Marlin"
#endif
#if defined (mattsch) && (!defined (LANGUAGE_H) && !MB(5DPRINT) ) || defined (mattschUpstream) && (!MOTHERBOARD == 77 && !defined (LANGUAGE_H) )

    #define FIRMWARE_URL "https://github.com/ErikZalm/Marlin/"
#endif
#if defined (upstream) && (!defined (MACHINE_UUID) && !defined (LANGUAGE_H) ) || defined (mattsch) && (!defined (MACHINE_UUID) && !defined (LANGUAGE_H) ) || defined (mattschUpstream) && (!defined (MACHINE_UUID) && !defined (LANGUAGE_H) )
...
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 1 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
...
#endif
#if defined (upstream) && !defined (LANGUAGE_H) || defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && (LANGUAGE_CHOICE == 1 && !defined (LANGUAGE_H) )
...
#endif
#if defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && (LANGUAGE_CHOICE == 1 && !defined (LANGUAGE_H) )
...
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 2 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
    ...
    #define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 3 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
    ...
    #define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 4 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
...
#endif
#if defined (upstream) && !defined (LANGUAGE_H) || defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && (LANGUAGE_CHOICE == 4 && !defined (LANGUAGE_H) )
    #define MSG_RESEND                          "Resend: "
    #define MSG_UNKNOWN_COMMAND                 "Unknown command: \""
    #define MSG_ACTIVE_EXTRUDER                 "Active Extruder: "
    #define MSG_INVALID_EXTRUDER                "Invalid extruder"
    ...
    #define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 5 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
    ...
    #define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 6 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
    ...
    #define MSG_RESUME_PRINT  					"ÐÑÐ¾Ð´Ð¾Ð»Ð¶Ð¸ÑÑ Ð¿ÐµÑÐ°ÑÑ"
    #define MSG_RESUME_PRINT					"ÐÑÐ¾Ð´Ð¾Ð»Ð¶Ð¸ÑÑ Ð¿ÐµÑÐ°ÑÑ"
    ...
    #define MSG_CONTROL_RETRACTF				"ÐÑÐºÐ°Ñ  F:"
    ...
    #define MSG_POWERUP							"ÐÐºÐ»ÑÑÐµÐ½Ð¸Ðµ Ð¿Ð¸ÑÐ°Ð½Ð¸Ñ"
    #define MSG_EXTERNAL_RESET					" ÐÐ½ÐµÑÐ½Ð¸Ð¹ ÑÐ±ÑÐ¾Ñ"
    ...
    #define MSG_CONFIGURATION_VER				" ÐÐ¾ÑÐ»ÐµÐ´Ð½ÐµÐµ Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ: "
    #define MSG_FREE_MEMORY						" ÐÐ°Ð¼ÑÑÐ¸ ÑÐ²Ð¾Ð±Ð¾Ð´Ð½Ð¾: "
    #define MSG_PLANNER_BUFFER_BYTES			"  ÐÑÑÑÐµÑ Ð¾ÑÐµÑÐµÐ´Ð¸ ÐºÐ¾Ð¼Ð°Ð½Ð´ Bytes: "
    #define MSG_OK								"ok"
    ...
    #define MSG_ERR_CHECKSUM_MISMATCH			"ÐºÐ¾Ð½ÑÑÐ¾Ð»ÑÐ½Ð°Ñ ÑÑÐ¼Ð¼Ð° Ð½Ðµ ÑÐ¾Ð²Ð¿Ð°Ð´Ð°ÐµÑ, Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÑÑ ÑÑÑÐ¾ÐºÐ°:"
    #define MSG_ERR_NO_CHECKSUM					"Ð½ÐµÑ ÐºÐ¾Ð½ÑÑÐ¾Ð»ÑÐ½Ð¾Ð¹ ÑÑÐ¼Ð¼Ñ Ð´Ð»Ñ ÑÑÑÐ¾ÐºÐ¸, Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÑÑ ÑÑÑÐ¾ÐºÐ°:"
    #define MSG_ERR_NO_LINENUMBER_WITH_CHECKSUM	"Ð½ÐµÑ ÑÑÑÐ¾ÐºÐ¸ Ð´Ð»Ñ ÐºÐ¾Ð½ÑÑÐ¾Ð»ÑÐ½Ð¾Ð¹ ÑÑÐ¼Ð¼Ñ, Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÑÑ ÑÑÑÐ¾ÐºÐ°:"
    #define MSG_FILE_PRINTED					"ÐÐµÑÐ°ÑÑ ÑÐ°Ð¹Ð»Ð° Ð·Ð°Ð²ÐµÑÑÐµÐ½Ð°"
    #define MSG_BEGIN_FILE_LIST					"Ð¡Ð¿Ð¸ÑÐ¾Ðº ÑÐ°Ð¹Ð»Ð¾Ð²"
    #define MSG_END_FILE_LIST					"ÐÐ¾Ð½ÐµÑ ÑÐ¿Ð¸ÑÐºÐ° ÑÐ°Ð¹Ð»Ð¾Ð²"
    #define MSG_M104_INVALID_EXTRUDER			"M104 Ð¾ÑÐ¸Ð±ÐºÐ° ÑÐºÑÑÑÑÐ´ÐµÑÐ° "
    #define MSG_M105_INVALID_EXTRUDER			"M105 Ð¾ÑÐ¸Ð±ÐºÐ° ÑÐºÑÑÑÑÐ´ÐµÑÐ° "
    #define MSG_M200_INVALID_EXTRUDER			"M200 Ð¾ÑÐ¸Ð±ÐºÐ° ÑÐºÑÑÑÑÐ´ÐµÑÐ° "
    #define MSG_M218_INVALID_EXTRUDER			"M218 Ð¾ÑÐ¸Ð±ÐºÐ° ÑÐºÑÑÑÑÐ´ÐµÑÐ° "
    #define MSG_ERR_NO_THERMISTORS				"ÐÐµÑ ÑÐµÑÐ¼Ð¸ÑÑÑÐ° - Ð½ÐµÑ ÑÐµÐ¼Ð¿ÐµÑÐ°ÑÑÑÑ"
    #define MSG_M109_INVALID_EXTRUDER			"M109 Ð¾ÑÐ¸Ð±ÐºÐ° ÑÐºÑÑÑÑÐ´ÐµÑÐ° "
    ...
    #define MSG_M115_REPORT						"FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
    #define MSG_COUNT_X							" Count X:"
    #define MSG_ERR_KILLED						"ÐÑÐ¸Ð½ÑÐµÑ Ð¾ÑÑÐ°Ð½Ð¾Ð²Ð»ÐµÐ½. Ð²ÑÐ·Ð¾Ð² kill() !!"
    #define MSG_ERR_STOPPED						"ÐÑÐ¸Ð±ÐºÐ° Ð¿ÑÐ¸Ð½ÑÐµÑÐ°, Ð¾ÑÑÐ°Ð½Ð¾Ð². Ð£ÑÑÑÐ°Ð½Ð¸ÑÐµ Ð½ÐµÐ¸ÑÐ¿ÑÐ°Ð²Ð½Ð¾ÑÑÑ Ð¸ Ð¸ÑÐ¿Ð¾Ð»ÑÐ·ÑÐ¹ÑÐµ M999 Ð´Ð»Ñ Ð¿ÐµÑÐµÐ·Ð°Ð³ÑÑÐ·ÐºÐ¸!. (Ð¢ÐµÐ¼Ð¿ÐµÑÐ°ÑÑÑÐ° Ð½ÐµÐ´Ð¾ÑÑÑÐ¿Ð½Ð°. ÐÑÐ¾Ð²ÐµÑÑÑÐµ Ð´Ð°ÑÑÐ¸ÐºÐ¸)"
    #define MSG_RESEND							"ÐÐµÑÐµÐ¾ÑÐ¿ÑÐ°Ð²ÐºÐ°:"
    #define MSG_UNKNOWN_COMMAND					"ÐÐµÐ¸Ð·Ð²ÐµÑÑÐ½Ð°Ñ ÐºÐ¾Ð¼Ð°Ð½Ð´Ð°:\""
    #define MSG_ACTIVE_EXTRUDER					"ÐÐºÑÐ¸Ð²Ð½ÑÐ¹ ÑÐºÑÑÑÑÐ´ÐµÑ: "
    #define MSG_INVALID_EXTRUDER				"ÐÑÐ¸Ð±ÐºÐ° ÑÐºÑÑÑÑÐ´ÐµÑÐ°"
    #define MSG_X_MIN							"x_min:"
    #define MSG_X_MAX							"x_max:"
    #define MSG_Y_MIN							"y_min:"
    #define MSG_Y_MAX							"y_max:"
    #define MSG_Z_MIN							"z_min:"
    #define MSG_Z_MAX							"z_max:"
    #define MSG_M119_REPORT						"Ð¡ÑÐ°ÑÑÑ ÐºÐ¾Ð½ÑÐµÐ²Ð¸ÐºÐ¾Ð²"
    #define MSG_ENDSTOP_HIT						"Ð¡ÑÐ°Ð±Ð°ÑÑÐ²Ð°Ð½Ð¸Ðµ ÐºÐ¾Ð½ÑÐµÐ²Ð¸ÐºÐ°"
    #define MSG_ENDSTOP_OPEN					"ÐÐ¾Ð½ÑÐµÐ²Ð¸Ðº Ð¾ÑÐ²Ð¾Ð±Ð¾Ð¶Ð´ÐµÐ½"
    #define MSG_HOTEND_OFFSET					"Hotend offsets:"
    #define MSG_SD_CANT_OPEN_SUBDIR				"ÐÐµ Ð¾ÑÐºÑÑÑÑ Ð¿Ð°Ð¿ÐºÑ"
    #define MSG_SD_INIT_FAIL					"ÐÑÐ¸Ð±ÐºÐ° Ð¸Ð½Ð¸ÑÐ¸Ð°Ð»Ð¸Ð·Ð°ÑÐ¸Ð¸ SD"
    #define MSG_SD_VOL_INIT_FAIL				"ÐÑÐ¸Ð±ÐºÐ° Ð¸Ð½Ð¸ÑÐ¸Ð°Ð»Ð¸Ð·Ð°ÑÐ¸Ð¸ ÑÐ°Ð·Ð´ÐµÐ»Ð°"
    #define MSG_SD_OPENROOT_FAIL				"ÐÐµ Ð¿ÑÐ¾ÑÐµÑÑÑ ÑÐ¾Ð´ÐµÑÐ¶Ð¸Ð¼Ð¾Ðµ ÐºÐ¾ÑÐ½Ñ"
    #define MSG_SD_CARD_OK						"SD ÐºÐ°ÑÑÐ° Ð² Ð¿Ð¾ÑÑÐ´ÐºÐµ"
    #define MSG_SD_WORKDIR_FAIL					"Ð½Ðµ Ð¾ÑÐºÑÑÑÑ ÑÐ°Ð±Ð¾ÑÑÑ Ð¿Ð°Ð¿ÐºÑ"
    #define MSG_SD_OPEN_FILE_FAIL				"ÐÑÐ¸Ð±ÐºÐ° ÑÑÐµÐ½Ð¸Ñ, ÑÐ°Ð¹Ð»: "
    ...
    #define MSG_SD_WRITE_TO_FILE				"ÐÐ°Ð¿Ð¸ÑÑ Ð² ÑÐ°Ð¹Ð»: "
    #define MSG_SD_PRINTING_BYTE				"SD Ð¿ÐµÑÐ°ÑÑ byte "
    #define MSG_SD_NOT_PRINTING					"Ð½ÐµÑ SD Ð¿ÐµÑÐ°ÑÐ¸"
    #define MSG_SD_ERR_WRITE_TO_FILE			"Ð¾ÑÐ¸Ð±ÐºÐ° Ð·Ð°Ð¿Ð¸ÑÐ¸ Ð² ÑÐ°Ð¹Ð»"
    #define MSG_SD_CANT_ENTER_SUBDIR			"ÐÐµ Ð·Ð°Ð¹ÑÐ¸ Ð² Ð¿Ð°Ð¿ÐºÑ:"
    #define MSG_STEPPER_TOO_HIGH				"Ð§Ð°ÑÑÐ¾ÑÐ° ÑÐ°Ð³Ð¾Ð² Ð¾ÑÐµÐ½Ñ Ð²ÑÑÐ¾ÐºÐ° : "
    #define MSG_ENDSTOPS_HIT					"ÐºÐ¾Ð½ÑÐµÐ²Ð¸Ðº ÑÑÐ°Ð±Ð¾ÑÐ°Ð»: "
    #define MSG_ERR_COLD_EXTRUDE_STOP			" Ð·Ð°ÑÐ¸ÑÐ° ÑÐ¾Ð»Ð¾Ð´Ð½Ð¾Ð¹ ÑÐºÑÑÑÑÐ·Ð¸Ð¸"
    #define MSG_ERR_LONG_EXTRUDE_STOP			" Ð·Ð°ÑÐ¸ÑÐ° Ð¿ÑÐµÐ²ÑÑÐµÐ½Ð¸Ñ Ð´Ð»Ð¸Ð½Ð½Ñ ÑÐºÑÑÑÑÐ·Ð¸Ð¸"
#endif
#if defined (upstream) && !defined (LANGUAGE_H) || defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && (LANGUAGE_CHOICE == 6 && !defined (LANGUAGE_H) )
    #define MSG_BABYSTEPPING_X                  "Babystepping X"
    #define MSG_BABYSTEPPING_Y                  "Babystepping Y"
    #define MSG_BABYSTEPPING_Z                  "Babystepping Z"
    #define MSG_SERIAL_ERROR_MENU_STRUCTURE     "Error in menu structure"
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 7 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
...
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 8 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
    #define WELCOME_MSG MACHINE_NAME " pronto."
...
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 9 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
    // Please note these are limited to 17 characters!
...
#endif
#if defined (upstream) && !defined (LANGUAGE_H) || defined (mattsch) && !defined (LANGUAGE_H) || defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
#endif
#if defined (upstream) && !defined (LANGUAGE_H)
    #include LANGUAGE_INCLUDE
#endif
#if defined (mattsch) && (  LANGUAGE_CHOICE == en && !defined (LANGUAGE_H) )
    // English
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    // Please note these are limited to 17 characters!
#endif
#if defined (mattsch) && (  LANGUAGE_CHOICE == en && !defined (LANGUAGE_H) )
...
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == pl && !defined (LANGUAGE_H) )
    // Polish
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
...
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == fr && !defined (LANGUAGE_H) )
    // French
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    ...
    #define MSG_AUTOSTART " Autostart"
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == de && !defined (LANGUAGE_H) )
    // German
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
...
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == es && !defined (LANGUAGE_H) )
    // Spanish
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    ...
    #define MSG_PREHEAT_PLA "Precalentar PLA"
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == ru && !defined (LANGUAGE_H) )
    // Russian
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    ...
    #define MSG_PREHEAT_ABS "Precalentar ABS"
#endif
#if defined (mattsch) && (!defined (LANGUAGE_H) && LANGUAGE_CHOICE == it )
    // Italian
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    ...
    #define MSG_COOLDOWN "Enfriar"
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == pt && !defined (LANGUAGE_H) )
    // Portuguese
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
...
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == fi && !defined (LANGUAGE_H) )
    // Finnish
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    #define MSG_EXTRUDE "Extruir"
    ...
    #define MSG_RETRACT "Retraer"
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == an && !defined (LANGUAGE_H) )
    // Aragonese
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 10 && !defined (LANGUAGE_H) )
    ...
    #define MSG_SERIAL_ERROR_MENU_STRUCTURE "Error in menu structure"
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == nl && !defined (LANGUAGE_H) ) || defined (mattschUpstream) && (LANGUAGE_CHOICE == 11 && !defined (LANGUAGE_H) )

    // Dutch
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == nl && !defined (LANGUAGE_H) )
    #include "language_nl.h"
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 11 && !defined (LANGUAGE_H) )
    // LCD Menu Messages
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == ca && !defined (LANGUAGE_H) )
    // Catalan
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 11 && !defined (LANGUAGE_H) )
    // Please note these are limited to 17 characters!
...
#endif
#if defined (mattsch) && (LANGUAGE_CHOICE == eu && !defined (LANGUAGE_H) )
    // Basque-Euskera
#endif
#if defined (mattschUpstream) && (LANGUAGE_CHOICE == 11 && !defined (LANGUAGE_H) )
