...
#endif
#if defined (A) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (B) && defined (EEPROM_CHITCHAT) || defined (C) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (D) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHOLN("");
    SERIAL_ECHO_START;
#endif
...
#endif
#if defined (A) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (B) && (defined (EEPROM_CHITCHAT) && defined (DELTA) ) || defined (C) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (D) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHOLN("");
#endif
#if defined (B) && (defined (EEPROM_CHITCHAT) && defined (DELTA) )
    /*
