...
#endif
#if defined (A) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (B) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) ) || defined (C) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHOLN("");
#endif
#if defined (A) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
