...
#endif
#if defined (B) && defined (SCARA) || defined (C) && defined (SCARA)
    #undef EEPROM_VERSION
...
#endif
#if defined (A) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (B) && (!defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (C) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHOLN("");
#endif
#if defined (A) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
