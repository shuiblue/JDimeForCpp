...
// Add scaling for SCARA
    ...
    EEPROM_WRITE_VAR(i,dummyByte);
#endif
#if defined (A) && (defined (EEPROM_SETTINGS) && defined (FWRETRACT) ) || defined (B) && defined (EEPROM_SETTINGS) || defined (C) && (defined (EEPROM_SETTINGS) && defined (FWRETRACT) )
...
#endif
#if defined (A) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (B) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) ) || defined (C) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHOLN("");
#endif
#if defined (A || C) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
