...
// validate data
    ...
    //EEPROM_SETTINGS
#endif
#if defined (A) && !defined (DISABLE_M503) || defined (B) && defined (EEPROM_CHITCHAT)
...
// Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
...
#endif
#if defined (A) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (B) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHOLN("");
    SERIAL_ECHO_START;
#endif
...
#endif
    SERIAL_ECHOLN("");
#if defined (A) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (B) && (defined (EEPROM_CHITCHAT) && defined (DELTA) )
    SERIAL_ECHO_START;
#endif
#if defined (A)
    ...
    */
#endif
#if defined (A) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (B) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHO_START;
...
#endif
#if defined (A) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (B) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHOLN("");
#endif
#if defined (A) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
...
#if defined (A) && (defined (EEPROM_CHITCHAT) && defined (EEPROM_SETTINGS) ) || defined (B) && defined (EEPROM_SETTINGS)
