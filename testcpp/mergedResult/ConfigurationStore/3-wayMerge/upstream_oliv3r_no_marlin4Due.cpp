...
// Add scaling for SCARA
    ...
    EEPROM_WRITE_VAR(i,dummyByte);
#endif
#if defined (A) && (defined (EEPROM_SETTINGS) && defined (FWRETRACT) ) || defined (B) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (A) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (B) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHO_START;
#endif
#if defined (A)
