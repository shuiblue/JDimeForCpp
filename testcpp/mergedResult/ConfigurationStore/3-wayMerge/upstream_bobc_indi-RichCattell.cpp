...
#endif
#if defined (A) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (B) && !defined (DISABLE_M503) || defined (C) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHOLN("");
    SERIAL_ECHO_START;
#endif
...
#endif
    SERIAL_ECHOLN("");
#if defined (A) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (B) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (C) && (defined (EEPROM_CHITCHAT) && defined (DELTA) )
    SERIAL_ECHO_START;
#endif
#if defined (A)
