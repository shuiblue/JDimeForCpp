...
#endif
#if defined (A) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (B) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (C) && (defined (PIDTEMP) && !defined (DISABLE_M503) )
    SERIAL_ECHOLN("");
#endif
#if defined (A) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
