...
#endif
#if defined (A) && defined (SDSUPPORT) || defined (E) && defined (SDSUPPORT)
...
#endif
#if defined (E) && defined (SDSUPPORT)
                (!filenameIsDir && (p.name[8] != 'G' || p.name[9] == '~'))
#endif
                continue;
#if defined (A) && defined (SDSUPPORT) || defined (B) && defined (SDSUPPORT) || defined (C) && defined (SDSUPPORT) || defined (D) && defined (SDSUPPORT)
            filenameIsDir=DIR_IS_SUBDIR(&p);
...
#endif
#if defined (A) && defined (SDSUPPORT) || defined (C) && defined (SDSUPPORT) || defined (D) && defined (SDSUPPORT) || defined (E) && defined (SDSUPPORT)
...
// relative path
        ...
        (file.remove(curDir, fname)) {
            ...
            SERIAL_PROTOCOL(fname);
#endif
#if defined (A) && defined (SDSUPPORT) || defined (D) && defined (SDSUPPORT) || defined (E) && defined (SDSUPPORT)
...
#endif
#if defined (A) && defined (SDSUPPORT) || defined (C) && defined (SDSUPPORT) || defined (D) && defined (SDSUPPORT)
        logging = false;
#endif
#if defined (A) && defined (SDSUPPORT) || defined (C) && defined (SDSUPPORT) || defined (D) && defined (SDSUPPORT) || defined (E) && defined (SDSUPPORT)
        if(store_location) {
