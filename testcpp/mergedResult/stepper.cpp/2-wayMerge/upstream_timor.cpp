...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (timor) && defined (ADVANCE)
    static long advance_rate, advance, final_advance = 0;
    static long old_advance = 0;
#endif
#if defined (upstream) && defined (ADVANCE) || defined (timor)
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (timor) && defined (Z_LATE_ENABLE)
        if
