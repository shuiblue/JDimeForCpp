...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (indi-RichCattell) && defined (ADVANCE)
...
#endif
#if defined (upstream) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (indi-RichCattell) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (upstream) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (indi-RichCattell) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
        if
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (indi-RichCattell) && defined (Z_LATE_ENABLE)
        if
