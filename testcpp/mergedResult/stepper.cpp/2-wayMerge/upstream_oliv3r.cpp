...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (oliv3r) && defined (ADVANCE)
...
#endif
#if defined (upstream) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (oliv3r) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
    bool abort_on_endstop_hit = false;
#endif
#if defined (upstream) && defined (MOTOR_CURRENT_PWM_XY_PIN) || defined (oliv3r) && MOTOR_CURRENT_PWM_XY_PIN > -1
...
#endif
#if defined (upstream) || defined (oliv3r) && defined (__AVR)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (upstream) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (oliv3r) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
        if
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (oliv3r) && defined (Z_LATE_ENABLE)
        if
