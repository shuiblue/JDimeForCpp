...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (indi-3DR) && defined (ADVANCE)
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (indi-3DR) && defined (Z_LATE_ENABLE)
        if
...
#endif
#if defined (indi-3DR) && defined (ADVANCE)
unsigned char old_OCR0A;
// Timer interrupt for E. e_steps is set in the main routine;
// Timer 0 is shared with millies
ISR(TIMER0_COMPA_vect)
