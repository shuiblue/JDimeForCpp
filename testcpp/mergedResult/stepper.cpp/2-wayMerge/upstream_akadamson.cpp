...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (akadamson) && defined (ADVANCE)
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (akadamson) && defined (Z_LATE_ENABLE)
        if
