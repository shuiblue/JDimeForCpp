...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (ut7) && defined (ADVANCE)
...
#endif
#if defined (upstream) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (ut7) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
    bool abort_on_endstop_hit = false;
#endif
#if defined (upstream) && defined (MOTOR_CURRENT_PWM_XY_PIN) || defined (ut7) && defined (MOTOR_CURRENT_PWM_XY_PIN)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (upstream) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (ut7) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT))
        if
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (ut7) && defined (Z_LATE_ENABLE)
        if
