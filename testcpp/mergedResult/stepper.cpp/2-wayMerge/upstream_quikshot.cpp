...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (quikshot) && defined (ADVANCE)
...
#endif
#if defined (upstream) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (quikshot) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
    bool abort_on_endstop_hit = false;
#endif
#if defined (upstream) && defined (MOTOR_CURRENT_PWM_XY_PIN) || defined (quikshot) && defined (MOTOR_CURRENT_PWM_XY_PIN)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (upstream) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (quikshot) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT))
        if
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (quikshot) && defined (Z_LATE_ENABLE)
        if
