...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (bobc) && defined (ADVANCE)
...
#endif
#if defined (upstream) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (bobc) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (upstream) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (bobc) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT))
        if
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (bobc) && defined (Z_LATE_ENABLE)
        if
