...
#endif
#if defined (upstream) && defined (ADVANCE) || defined (gregor2005) && defined (ADVANCE)
...
#endif
#if defined (upstream) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (gregor2005) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (upstream) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (gregor2005) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
        if
...
#if defined (upstream) && defined (Z_LATE_ENABLE) || defined (gregor2005) && defined (Z_LATE_ENABLE)
        if
...
#endif
#if defined (gregor2005) && defined (ADVANCE)
unsigned char old_OCR0A;
// Timer interrupt for E. e_steps is set in the main routine;
// Timer 0 is shared with millies
ISR(TIMER0_COMPA_vect)
