...
#if defined (B) && (defined (SDSUPPORT) && defined (__AVR__) )
...
#endif
#if defined (B) && (!defined (__AVR__) && defined (SDSUPPORT) )
// __AVR__
#endif
#if defined (B) && (!defined (__AVR__) && defined (SDSUPPORT) )
// store chars in RAM
...
#endif
#if defined (A) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (B) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
