...
#include "MarlinSerial.h"
    ...
    // !teensylu
#endif
#if defined (upstream) && !defined (AT90USB) || defined (timor) && MOTHERBOARD != 8
    ...
    // this is so I can support Attiny series and any other chip without a uart
#endif
#if defined (upstream) && ((defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )!defined (AT90USB) && UART_PRESENT(SERIAL_PORT) ) || defined (timor) && ((defined(UBRRH) || defined(UBRR0H) && )(defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )MOTHERBOARD != 8 )
ring_buffer rx_buffer  =  { { 0 }, 0, 0 };
#endif
#if defined (upstream) && ((defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )!defined (AT90USB) ) || defined (timor) && ((defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )MOTHERBOARD != 8 )
...
#endif
#if defined (upstream) && (defined(M_USARTx_RX_vect) && (defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )!defined (AT90USB) ) || defined (timor) && ((defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )defined(USART0_RX_vect) && MOTHERBOARD != 8 )
...
#endif
#if defined (upstream) && ((F_CPU == 16000000UL && SERIAL_PORT == 0 && )(defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )!defined (AT90USB) ) || defined (timor) && ((defined(UBRRH) || defined(UBRR0H) || defined(UBRR1H) || defined(UBRR2H) || defined(UBRR3H) && )F_CPU == 16000000UL && MOTHERBOARD != 8 )
