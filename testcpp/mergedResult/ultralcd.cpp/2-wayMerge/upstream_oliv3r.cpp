#if defined (upstream) || defined (oliv3r)
    #include "temperature.h"
    #include "ultralcd.h"
#endif
#if defined (upstream) && defined (ULTRA_LCD) || defined (oliv3r) && defined (ULTRA_LCD)
    #include "Marlin.h"
    #include "language.h"
...
#endif
#if defined (upstream) && (defined (DOGLCD) && defined (ULTRA_LCD) ) || defined (oliv3r) && (defined (DOGLCD) && defined (ULTRA_LCD) )
    #include "dogm_lcd_implementation.h"
#endif
#if defined (oliv3r) && (defined(ULTIBOARD_V2_CONTROLLER) && defined (ULTRA_LCD) )
    #include "ultralcd_implementation_ultiboard_v2.h"
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (DOGLCD) ) || defined (oliv3r) && (!defined(ULTIBOARD_V2_CONTROLLER) && defined (ULTRA_LCD) )
    #include "ultralcd_implementation_hitachi_HD44780.h"
#endif
#if defined (upstream) && defined (ULTRA_LCD)
    /** forward declarations **/
#endif
#if defined (oliv3r) && defined (ULTRA_LCD)
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && !defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) && defined (ULTIPANEL) )
...
#if defined (upstream) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
        if
#if defined (upstream) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
        (card.cardOK)
#endif
#if defined (oliv3r) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
            (card.isOk())
#endif
        {
            if
...
#if defined (upstream) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (oliv3r) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
...
#if defined (upstream) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(int3, MSG_NOZZLE, &target_temperature[0], 0, HEATER_0_MAXTEMP - 15);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && TEMP_SENSOR_1 != 0 && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && TEMP_SENSOR_1 != 0 && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(int3, MSG_NOZZLE1, &target_temperature[1], 0, HEATER_1_MAXTEMP - 15);
#endif
#if defined (upstream) && (TEMP_SENSOR_2 != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (oliv3r) && (TEMP_SENSOR_2 != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(int3, MSG_NOZZLE2, &target_temperature[2], 0, HEATER_2_MAXTEMP - 15);
#endif
#if defined (upstream) && (TEMP_SENSOR_BED != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (oliv3r) && (TEMP_SENSOR_BED != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) )
...
//    MENU_ITEM_EDIT(int3, MSG_CONTRAST, &lcd_contrast, 0, 63);
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) )
        MENU_ITEM(submenu, MSG_RETRACT, lcd_control_retract_menu);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (EEPROM_SETTINGS) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (EEPROM_SETTINGS) && defined (ULTIPANEL) )
    ...
    static void lcd_control_temperature_menu
    () {
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) )
// set up temp variables - undo the default scaling
        ...
        MENU_ITEM_EDIT(byte, MSG_FAN_SPEED, &fanSpeed, 0, 255);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && (defined AUTOTEMP && (TEMP_SENSOR_0 != 0) && )defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (AUTOTEMP) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined ( PID_ADD_EXTRUSION_RATE) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined ( PID_ADD_EXTRUSION_RATE) && defined (ULTIPANEL) )
...
#endif
#if defined (oliv3r) && (defined (ULTRA_LCD) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined (ULTIPANEL) )
...
//FWRETRACT
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) )
...
//ULTIPANEL
    ...
    () {
        ...
        SET_INPUT(BTN_EN1);
#endif
#if defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) ) || defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) )
        WRITE(BTN_EN1,HIGH);
        WRITE(BTN_EN2,HIGH);
#endif
        ...
        SET_INPUT(BTN_ENC);
#endif
#if defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 )
        pinMode(BTN_ENC,INPUT);
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 ) || defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 )
        WRITE(BTN_ENC,HIGH);
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) ) || defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined(SHIFT_CLK) && !defined (NEWPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && !defined (NEWPANEL) )
        pinMode(SHIFT_CLK,OUTPUT);
        pinMode(SHIFT_LD,OUTPUT);
...
//!NEWPANEL
        ...
        pinMode(SDCARDDETECT,INPUT);
#endif
#if defined (upstream) && ((defined (SDSUPPORT) && defined(SDCARDDETECT) && (SDCARDDETECT > 0) && )defined (ULTRA_LCD) ) || defined (oliv3r) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) )
...
//(SDCARDDETECT > 0)
    ...
    () {
        ...
        lcd_buttons_update();
#endif
#if defined (oliv3r) && (defined (ULTRA_LCD) && defined (LCD_HAS_SLOW_BUTTONS) )
        buttons |= lcd_implementation_read_slow_buttons();
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (LCD_HAS_SLOW_BUTTONS) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (LCD_HAS_SLOW_BUTTONS) )
// buttons which take too long to read in interrupt context
#endif
#if defined (upstream) && defined (ULTRA_LCD)
        lcd_buttons_update();
#endif
#if defined (oliv3r) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) )
...
// Terminate display update, when nothing new to draw. This must be done before the last dogm.next()
            ...
            (*currentMenu)();
#endif
#if defined (upstream) && (defined (LCD_HAS_STATUS_INDICATORS) && defined (ULTRA_LCD) ) || defined (oliv3r) && (defined (LCD_HAS_STATUS_INDICATORS) && defined (ULTRA_LCD) )
...
//ULTIPANEL
    ...
    () {
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        uint8_t newbutton=0;
        if
        (READ(BTN_EN1)==0)
            newbutton|=EN_A;
        ...
        (READ(BTN_EN2)==0)
            newbutton|=EN_B;
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 && defined (ULTIPANEL) )
        if
        ((blocking_enc<millis()) && (READ(BTN_ENC)==0))
            newbutton |= EN_C;
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        buttons = newbutton;
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (LCD_HAS_SLOW_BUTTONS) )
        buttons |= slow_buttons;
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
...
#endif
#if defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
        newbutton |= ((~newbutton_reprapworld_keypad) << REPRAPWORLD_BTN_OFFSET);
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
//invert it, because a pressed switch produces a logical 0
#endif
#if defined (oliv3r) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        buttons = newbutton;
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (NEWPANEL) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (ULTRA_LCD) && !defined (NEWPANEL) && defined (ULTIPANEL) )
...
#if defined (upstream) && (defined (LCD_USE_I2C_BUZZER) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (oliv3r) && (defined (LCD_USE_I2C_BUZZER) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
// grab the pid i value out of the temp variable; scale it; then update the PID driver
    ...
    void copy_and_scalePID_i
    () {
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) ) || defined (oliv3r) && (defined (ULTRA_LCD) && defined (PIDTEMP) )
