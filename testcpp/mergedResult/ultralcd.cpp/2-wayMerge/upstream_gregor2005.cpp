    ...
    #include "ultralcd.h"
#endif
#if defined (upstream) && defined (ULTRA_LCD) || defined (gregor2005) && defined (ULTRA_LCD)
    #include "Marlin.h"
    #include "language.h"
...
#endif
#if defined (upstream) && (defined (DOGLCD) && defined (ULTRA_LCD) ) || defined (gregor2005) && (defined (DOGLCD) && defined (ULTRA_LCD) )
    #include "dogm_lcd_implementation.h"
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (DOGLCD) ) || defined (gregor2005) && (defined (ULTRA_LCD) && !defined (DOGLCD) )
    #include "ultralcd_implementation_hitachi_HD44780.h"
#endif
#if defined (upstream) && defined (ULTRA_LCD)
    /** forward declarations **/
#endif
#if defined (gregor2005) && defined (ULTRA_LCD)
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && (SDCARDDETECT > -1) && defined (ULTIPANEL) )
...
#if defined (upstream) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
        if
        (card.cardOK) {
            if
            (card.isFileOpen()) {
...
#if defined (upstream) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (gregor2005) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
...
#if defined (upstream) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(int3, MSG_NOZZLE, &target_temperature[0], 0, HEATER_0_MAXTEMP - 15);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && TEMP_SENSOR_1 != 0 && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && TEMP_SENSOR_1 != 0 && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(int3, MSG_NOZZLE1, &target_temperature[1], 0, HEATER_1_MAXTEMP - 15);
#endif
#if defined (upstream) && (TEMP_SENSOR_2 != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (gregor2005) && (TEMP_SENSOR_2 != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(int3, MSG_NOZZLE2, &target_temperature[2], 0, HEATER_2_MAXTEMP - 15);
#endif
#if defined (upstream) && (TEMP_SENSOR_BED != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (gregor2005) && (TEMP_SENSOR_BED != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) )
...
#endif
#if defined (gregor2005) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
//MENU_ITEM(function, MSG_AUTOSTART, lcd_autostart_sd);
#endif
...
//    MENU_ITEM_EDIT(int3, MSG_CONTRAST, &lcd_contrast, 0, 63);
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) )
        MENU_ITEM(submenu, MSG_RETRACT, lcd_control_retract_menu);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (EEPROM_SETTINGS) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (EEPROM_SETTINGS) && defined (ULTIPANEL) )
    ...
    static void lcd_control_temperature_menu
    () {
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
        MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &fanSpeed, 0, 255);
#if defined (upstream) && (defined (ULTRA_LCD) && (defined AUTOTEMP && (TEMP_SENSOR_0 != 0) && )defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (AUTOTEMP) && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(bool, MSG_AUTOTEMP, &autotemp_enabled);
        MENU_ITEM_EDIT(float3, MSG_MIN, &autotemp_min, 0, HEATER_0_MAXTEMP - 15);
        MENU_ITEM_EDIT(float3, MSG_MAX, &autotemp_max, 0, HEATER_0_MAXTEMP - 15);
        MENU_ITEM_EDIT(float32, MSG_FACTOR, &autotemp_factor, 0.0, 1.0);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) )
        MENU_ITEM_EDIT(float52, MSG_PID_P, &Kp, 1, 9990);
// i is typically a small value so allows values below 1
        MENU_ITEM_EDIT_CALLBACK(float52, MSG_PID_I, &raw_Ki, 0.01, 9990, copy_and_scalePID_i);
        MENU_ITEM_EDIT_CALLBACK(float52, MSG_PID_D, &raw_Kd, 1, 9990, copy_and_scalePID_d);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined ( PID_ADD_EXTRUSION_RATE) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined ( PID_ADD_EXTRUSION_RATE) && defined (ULTIPANEL) )
...
#endif
#if defined (gregor2005) && (defined (ULTRA_LCD) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined (ULTIPANEL) )
...
//FWRETRACT
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) )
...
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
...
//ULTIPANEL
    ...
    () {
        ...
        SET_INPUT(BTN_EN1);
#endif
#if defined (gregor2005) && (defined (NEWPANEL) && defined (ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) ) || defined (gregor2005) && (defined (NEWPANEL) && defined (ULTRA_LCD) )
        WRITE(BTN_EN1,HIGH);
        WRITE(BTN_EN2,HIGH);
#endif
        ...
        SET_INPUT(BTN_ENC);
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 ) || defined (gregor2005) && (defined (NEWPANEL) && defined (ULTRA_LCD) )
        WRITE(BTN_ENC,HIGH);
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) ) || defined (gregor2005) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined(SHIFT_CLK) && !defined (NEWPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && !defined (NEWPANEL) )
        pinMode(SHIFT_CLK,OUTPUT);
        pinMode(SHIFT_LD,OUTPUT);
...
//!NEWPANEL
        ...
        pinMode(SDCARDDETECT,INPUT);
#endif
#if defined (upstream) && ((defined (SDSUPPORT) && defined(SDCARDDETECT) && (SDCARDDETECT > 0) && )defined (ULTRA_LCD) ) || defined (gregor2005) && (defined (ULTRA_LCD) && (SDCARDDETECT > -1) )
...
#endif
        lcd_buttons_update();
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (gregor2005) && defined (ULTRA_LCD)
        encoderDiff = 0;
#endif
    }
    void lcd_update
...
#endif
#if defined (gregor2005) && (defined (ULTRA_LCD) && (SDCARDDETECT > -1) )
...
//ULTIPANEL
    ...
    () {
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        uint8_t newbutton=0;
        if
        (READ(BTN_EN1)==0)
            newbutton|=EN_A;
        ...
        (READ(BTN_EN2)==0)
            newbutton|=EN_B;
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        if
...
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (NEWPANEL) && defined (ULTIPANEL) ) || defined (gregor2005) && (defined (ULTRA_LCD) && !defined (NEWPANEL) && defined (ULTIPANEL) )
...
// grab the pid i value out of the temp variable; scale it; then update the PID driver
    ...
    void copy_and_scalePID_i
    () {
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) ) || defined (gregor2005) && defined (ULTRA_LCD)
