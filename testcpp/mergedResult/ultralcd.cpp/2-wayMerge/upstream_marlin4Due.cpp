    ...
    #include "ultralcd.h"
#endif
#if defined (upstream) && defined (ULTRA_LCD) || defined (marlin4Due) && ENABLED(ULTRA_LCD)
    #include "Marlin.h"
    #include "language.h"
...
#endif
#if defined (upstream) && (defined (DOGLCD) && defined (ULTRA_LCD) ) || defined (marlin4Due) && (ENABLED(ULTRA_LCD) && ENABLED(DOGLCD) )
    #include "dogm_lcd_implementation.h"
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (DOGLCD) ) || defined (marlin4Due) && (!ENABLED(DOGLCD) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (HAS_POWER_SWITCH && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
    extern bool powersupply;
#endif
#if defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
    const float manual_feedrate[] = MANUAL_FEEDRATE;
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (DOGLCD) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(HAS_LCD_CONTRAST) )
    static void lcd_set_contrast();
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(FWRETRACT) && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
    static void lcd_control_retract_menu();
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
    static void lcd_sdcard_menu();
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (DELTA_CALIBRATION_MENU) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(DELTA_CALIBRATION_MENU) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && DISABLED(LCD_I2C_VIKI) )
    #define ENCODER_STEPS_PER_MENU_ITEM 5
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_PULSES_PER_STEP) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && !defined (ENCODER_PULSES_PER_STEP) && DISABLED(LCD_I2C_VIKI) )
    #define ENCODER_PULSES_PER_STEP 1
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && !DISABLED(LCD_I2C_VIKI) )
    #define ENCODER_STEPS_PER_MENU_ITEM 2
    // VIKI LCD rotary encoder uses a different number of steps per rotation
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined(LCD_I2C_VIKI) && !defined (ENCODER_PULSES_PER_STEP) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && !DISABLED(LCD_I2C_VIKI) && !defined (ENCODER_PULSES_PER_STEP) )
    #define ENCODER_PULSES_PER_STEP 1
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(REPRAPWORLD_KEYPAD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (LCD_HAS_SLOW_BUTTONS) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(LCD_HAS_SLOW_BUTTONS) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && (SDCARDDETECT > 0) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (FILAMENT_LCD_DISPLAY) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(FILAMENT_LCD_DISPLAY) && ENABLED(ULTRA_LCD) )
// get status message to show up for a while
#endif
            }
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL_FEEDMULTIPLY) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTIPANEL_FEEDMULTIPLY) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && defined (SDSUPPORT) )
...
#if defined (upstream) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(SDSUPPORT) && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
            if
            (card.cardOK) {
                if
                (card.isFileOpen()) {
...
#if defined (upstream) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(SDSUPPORT) && SDCARDDETECT < 1 && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && (ENABLED(SDSUPPORT) && ENABLED(MENU_ADDAUTOSTART) &)
...
#endif
#if defined (upstream) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(BABYSTEPPING) )
...
//BABYSTEPPING
        ...
        () {
            ...
            ;
#endif
#if defined (upstream) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (BABYSTEP_XY) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(BABYSTEPPING) && ENABLED(BABYSTEP_XY) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(FILAMENTCHANGEENABLE) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && TEMP_SENSOR_1 != 0 && defined (ULTIPANEL) ) || defined (marlin4Due) && (EXTRUDERS > 1 && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
//3 extruder preheat
#endif
#if defined (upstream) && (TEMP_SENSOR_2 != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (EXTRUDERS > 2 && EXTRUDERS > 1 && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
// EXTRUDERS > 1
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (TEMP_SENSOR_BED != 0 && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (upstream) && (TEMP_SENSOR_BED != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (TEMP_SENSOR_BED != 0 && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
//
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) && (TEMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_BED != 0 &) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && (TEMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_3 != 0 || TEMP_SENSOR_BED != 0 && )TEMP_SENSOR_0 != 0 )
            MENU_ITEM(submenu, MSG_PREHEAT_PLA, lcd_preheat_pla_menu);
            MENU_ITEM(submenu, MSG_PREHEAT_ABS, lcd_preheat_abs_menu);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && (EMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_BED != 0 && )TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && (EMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_3 != 0 || TEMP_SENSOR_BED != 0 && )TEMP_SENSOR_0 != 0 )
            MENU_ITEM(function, MSG_PREHEAT_PLA, lcd_preheat_pla0);
            MENU_ITEM(function, MSG_PREHEAT_ABS, lcd_preheat_abs0);
#endif
#if defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
//
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && PS_ON_PIN > -1 && defined (ULTIPANEL) ) || defined (marlin4Due) && (HAS_POWER_SWITCH && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
            if
            (powersupply) {
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) ) || defined (marlin4Due) && (ENABLED(FWRETRACT) && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
            MENU_ITEM(submenu, MSG_RETRACT, lcd_control_retract_menu);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (EEPROM_SETTINGS) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(EEPROM_SETTINGS) )
...
//
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && (defined AUTOTEMP && (TEMP_SENSOR_0 != 0) && )defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && (ENABLED(AUTOTEMP) && (TEMP_SENSOR_0 != 0) &)
...
// set up temp variables - undo the default scaling
            ...
            ;
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) ) || defined (marlin4Due) && (EXTRUDERS > 3 && EXTRUDERS > 2 && ENABLED(PID_PARAMS_PER_EXTRUDER) && EXTRUDERS > 1 && ENABLED(ULTIPANEL) && ENABLED(PIDTEMP) && ENABLED(ULTRA_LCD) )
// i is typically a small value so allows values below 1
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) )
...
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) )
            MENU_ITEM_EDIT(bool, MSG_ENDSTOP_ABORT, &abort_on_endstop_hit);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined (SCARA) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(SCARA) )
...
//EXTRUDERS > 1
        ...
        () {
            ...
            (encoderPosition != 0) {
                ...
                lcd_contrast &= 0xFF;
#endif
#if defined (upstream) && (defined (DOGLCD) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(HAS_LCD_CONTRAST) && !ENABLED(U8GLIB_LM6059_AF) )
                lcd_contrast -= encoderPosition;
#endif
...
#if defined (upstream) && (EXTRUDERS > 1 && defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) ) || defined (marlin4Due) && (ENABLED(FWRETRACT) && EXTRUDERS > 1 && ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
//FWRETRACT
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && defined (SDSUPPORT) && SDCARDDETECT == -1 )
...
// nothing to do (so don't thrash the SD card)
            ...
            if
            (card.filename[0]=='/') {
#if defined (upstream) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && SDCARDDETECT == -1 && defined (SDSUPPORT) )
#endif
            } else {
...
//ULTIPANEL
        ...
        () {
...
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) ) || defined (marlin4Due) && (ENABLED(ULTRA_LCD) && ENABLED(NEWPANEL) )
            SET_INPUT(BTN_EN1);
            SET_INPUT(BTN_EN2);
#endif
            ...
            PULLUP(BTN_EN2,HIGH);
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 ) || defined (marlin4Due) && (BTN_ENC > 0 && ENABLED(ULTRA_LCD) && ENABLED(NEWPANEL) )
            SET_INPUT(BTN_ENC);
#endif
            ...
            PULLUP(BTN_ENC,HIGH);
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) ) || defined (marlin4Due) && (ENABLED(ULTRA_LCD) && ENABLED(REPRAPWORLD_KEYPAD) && ENABLED(NEWPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (NEWPANEL) ) || defined (marlin4Due) && (ENABLED(ULTRA_LCD) && !ENABLED(NEWPANEL) )
// Not NEWPANEL
#endif
#if defined (upstream) && (defined (SR_LCD_2W_NL) && defined (ULTRA_LCD) && !defined (NEWPANEL) ) || defined (marlin4Due) && (ENABLED(ULTRA_LCD) && ENABLED(SR_LCD_2W_NL) && !ENABLED(NEWPANEL) )
// Non latching 2 wire shift register
            pinMode (SR_DATA_PIN, OUTPUT);
            pinMode (SR_CLK_PIN, OUTPUT);
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && defined(SHIFT_CLK) && !defined (NEWPANEL) ) || defined (marlin4Due) && (defined(SHIFT_CLK) && ENABLED(ULTRA_LCD) && !ENABLED(NEWPANEL) )
            pinMode(SHIFT_CLK,OUTPUT);
            pinMode(SHIFT_LD,OUTPUT);
...
#endif
//!NEWPANEL
#if defined (upstream) && ((defined (SDSUPPORT) && defined(SDCARDDETECT) && (SDCARDDETECT > 0) && )defined (ULTRA_LCD) ) || defined (marlin4Due) && ((ENABLED(SDSUPPORT) && defined(SDCARDDETECT) && (SDCARDDETECT > 0) && )ENABLED(ULTRA_LCD) )
...
#endif
//(SDCARDDETECT > 0)
#if defined (upstream) && (defined (ULTRA_LCD) && defined (LCD_HAS_SLOW_BUTTONS) ) || defined (marlin4Due) && (ENABLED(ULTRA_LCD) && ENABLED(LCD_HAS_SLOW_BUTTONS) )
            slow_buttons = 0;
#endif
            lcd_buttons_update();
#if defined (upstream) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
...
#endif
#if defined (marlin4Due) && ((SDCARDDETECT > 0) && ENABLED(ULTRA_LCD) )
            if (IS_SD_INSERTED != lcd_oldcardstatus && lcd_detected()) {
                lcdDrawUpdate = 2;
                lcd_oldcardstatus = IS_SD_INSERTED;
                lcd_implementation_init( // to maybe revive the LCD if static electricity killed it.
...
#endif
#if defined (upstream) && (defined (DOGLCD) && defined (ULTRA_LCD) ) || defined (marlin4Due) && (ENABLED(ULTRA_LCD) && ENABLED(HAS_LCD_CONTRAST) )
...
#define encrot3 1
        ...
        () {
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(NEWPANEL) )
            uint8_t newbutton=0;
            if
            (READ(BTN_EN1)==0)
                newbutton|=EN_A;
            ...
            millis_t ms = millis();
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && BTN_ENC > 0 && ENABLED(ULTRA_LCD) && ENABLED(NEWPANEL) )
            if
            ...
            buttons = newbutton;
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (LCD_HAS_SLOW_BUTTONS) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(NEWPANEL) && ENABLED(LCD_HAS_SLOW_BUTTONS) )
            buttons |= slow_buttons;
#endif
#if defined (upstream) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ENABLED(REPRAPWORLD_KEYPAD) && ENABLED(NEWPANEL) )
...
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && !defined (NEWPANEL) && defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && !ENABLED(NEWPANEL) )
...
//manage encoder rotation
        ...
        bool lcd_detected
        (void) {
#if defined (upstream) && (defined (ULTRA_LCD) && ((defined(LCD_I2C_TYPE_MCP23017) || defined(LCD_I2C_TYPE_MCP23008)) && defined(DETECT_DEVICE) && )defined (ULTIPANEL) ) || defined (marlin4Due) && (ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) && ((ENABLED(LCD_I2C_TYPE_MCP23017) || ENABLED(LCD_I2C_TYPE_MCP23008)) && ENABLED(DETECT_DEVICE) &)
            return lcd.LcdDetected() == 1;
#endif
#if defined (upstream) && (defined (ULTRA_LCD) && (!(defined(LCD_I2C_TYPE_MCP23017) || defined(LCD_I2C_TYPE_MCP23008)) && defined(DETECT_DEVICE) && )defined (ULTIPANEL) ) || defined (marlin4Due) && ((!(ENABLED(LCD_I2C_TYPE_MCP23017) || ENABLED(LCD_I2C_TYPE_MCP23008)) && ENABLED(DETECT_DEVICE) && )ENABLED(ULTIPANEL) && ENABLED(ULTRA_LCD) )
            return true;
#endif
        }
#endif
