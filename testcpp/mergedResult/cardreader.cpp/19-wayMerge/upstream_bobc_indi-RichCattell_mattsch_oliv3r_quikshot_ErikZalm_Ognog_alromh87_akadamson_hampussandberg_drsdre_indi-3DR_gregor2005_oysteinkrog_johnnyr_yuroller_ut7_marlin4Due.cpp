...
#endif
#if defined (indi-RichCattell) && defined (SDSUPPORT) || defined (akadamson) && defined (SDSUPPORT) || defined (drsdre) && defined (SDSUPPORT) || defined (indi-3DR) && defined (SDSUPPORT) || defined (gregor2005) && defined (SDSUPPORT)
    (char* name,bool read)
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (bobc) && defined (SDSUPPORT) || defined (mattsch) && defined (SDSUPPORT) || defined (quikshot) && defined (SDSUPPORT) || defined (ErikZalm) && defined (SDSUPPORT) || defined (Ognog) && defined (SDSUPPORT) || defined (alromh87) && defined (SDSUPPORT) || defined (hampussandberg) && defined (SDSUPPORT) || defined (oysteinkrog) && defined (SDSUPPORT) || defined (johnnyr) && defined (SDSUPPORT) || defined (yuroller) && defined (SDSUPPORT) || defined (ut7) && defined (SDSUPPORT) || defined (marlin4Due) && defined (SDSUPPORT)
...
#if defined (indi-RichCattell) && defined (SDSUPPORT) || defined (oliv3r) && defined (SDSUPPORT) || defined (alromh87) && defined (SDSUPPORT) || defined (akadamson) && defined (SDSUPPORT) || defined (drsdre) && defined (SDSUPPORT) || defined (indi-3DR) && defined (SDSUPPORT) || defined (gregor2005) && defined (SDSUPPORT)
            SERIAL_PROTOCOL(fname);
#endif
...
#if defined (akadamson) && defined (SDSUPPORT) || defined (drsdre) && defined (SDSUPPORT) || defined (indi-3DR) && defined (SDSUPPORT) || defined (gregor2005) && defined (SDSUPPORT)
