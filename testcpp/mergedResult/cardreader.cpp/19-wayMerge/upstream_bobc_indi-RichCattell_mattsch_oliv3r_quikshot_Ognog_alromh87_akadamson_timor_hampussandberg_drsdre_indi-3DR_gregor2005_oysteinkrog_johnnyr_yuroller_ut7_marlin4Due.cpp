...
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (mattsch) && defined (SDSUPPORT) || defined (oysteinkrog) && defined (SDSUPPORT) || defined (yuroller) && defined (SDSUPPORT) || defined (marlin4Due) && defined (SDSUPPORT)
...
// close() is done automatically by destructor of SdFile
            ...
            (p.name[0] == DIR_NAME_FREE)
                ...
                break;
            if
#if defined (upstream) && defined (SDSUPPORT) || defined (mattsch) && defined (SDSUPPORT) || defined (oysteinkrog) && defined (SDSUPPORT) || defined (yuroller) && defined (SDSUPPORT)
...
// relative path
        ...
        (file.remove(curDir, fname)) {
            ...
            SERIAL_PROTOCOL(fname);
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (bobc) && defined (SDSUPPORT) || defined (mattsch) && defined (SDSUPPORT) || defined (quikshot) && defined (SDSUPPORT) || defined (Ognog) && defined (SDSUPPORT) || defined (hampussandberg) && defined (SDSUPPORT) || defined (oysteinkrog) && defined (SDSUPPORT) || defined (johnnyr) && defined (SDSUPPORT) || defined (yuroller) && defined (SDSUPPORT) || defined (ut7) && defined (SDSUPPORT) || defined (marlin4Due) && defined (SDSUPPORT)
