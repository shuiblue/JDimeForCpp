...
//the SD start is delayed, because otherwise the serial cannot answer fast enough to make contact with the host software.
    ...
    lastnr=0;
//power to SD reader
#if defined (upstream) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (bobc) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (indi-RichCattell) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (mattsch) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (oliv3r) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (quikshot) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (ErikZalm) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (Ognog) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (alromh87) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (akadamson) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (timor) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (hampussandberg) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (drsdre) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (indi-3DR) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (gregor2005) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (oysteinkrog) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (johnnyr) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (yuroller) && (SDPOWER > -1 && defined (SDSUPPORT) ) || defined (ut7) && (SDPOWER > -1 && defined (SDSUPPORT) )
    SET_OUTPUT(SDPOWER);
    WRITE(SDPOWER,HIGH);
#endif
//SDPOWER
