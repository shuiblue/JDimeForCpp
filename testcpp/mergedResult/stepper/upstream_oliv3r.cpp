...
#endif
#if defined (A) && defined (MOTOR_CURRENT_PWM_XY_PIN) || defined (B) && MOTOR_CURRENT_PWM_XY_PIN > -1
...
#endif
#if defined (A) || defined (B) && defined (__AVR)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (A) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (B) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
        if
