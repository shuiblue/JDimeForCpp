...
#endif
#if defined (A) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1)
    #include <SPI.h>
#endif
#if defined (A) || defined (B)
    //===========================================================================
...
#endif
#if defined (A) && defined (ADVANCE) || defined (B)
...
#endif
#if defined (A) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
    bool abort_on_endstop_hit = false;
#endif
#if defined (A) && defined (MOTOR_CURRENT_PWM_XY_PIN)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (A) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT))
