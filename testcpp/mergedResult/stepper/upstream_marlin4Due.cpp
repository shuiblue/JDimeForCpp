...
#endif
#if defined (A) && defined (ADVANCE) || defined (B) && ENABLED(ADVANCE)
    static long advance_rate, advance, final_advance = 0;
    static long old_advance = 0;
#endif
#if defined (A) && defined (ADVANCE)
    static long e_steps[3];
#endif
#if defined (B) && ENABLED(ADVANCE)
...
#endif
#if defined (B) && DISABLED(Z_DUAL_ENDSTOPS)
    static byte
#else
    static uint16_t
#endif
...
#endif
#if defined (A) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (B) && (DISABLED(Z_DUAL_ENDSTOPS) && ENABLED(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) )
    bool abort_on_endstop_hit = false;
#endif
#if defined (A) && defined (MOTOR_CURRENT_PWM_XY_PIN) || defined (B) && (PIN_EXISTS(MOTOR_CURRENT_PWM_XY) && DISABLED(Z_DUAL_ENDSTOPS) )
...
#endif
#if defined (A) || defined (B) && DISABLED(Z_DUAL_ENDSTOPS)
...
#endif
#if defined (B) && (DISABLED(Z_DUAL_ENDSTOPS) && ENABLED(DUAL_X_CARRIAGE) )
...
#endif
#if defined (B) && (!ENABLED(DUAL_X_CARRIAGE) && DISABLED(Z_DUAL_ENDSTOPS) )
    #define X_APPLY_DIR(v,Q) X_DIR_WRITE(v)
    #define X_APPLY_STEP(v,Q) X_STEP_WRITE(v)
#endif
#if defined (B) && (ENABLED(Y_DUAL_STEPPER_DRIVERS) && DISABLED(Z_DUAL_ENDSTOPS) )
...
#endif
#if defined (B) && (ENABLED(Z_DUAL_STEPPER_DRIVERS) && DISABLED(Z_DUAL_ENDSTOPS) )
    #define Z_APPLY_DIR(v,Q) { Z_DIR_WRITE(v); Z2_DIR_WRITE(v); }
#endif
#if defined (B) && (ENABLED(Z_DUAL_ENDSTOPS) && ENABLED(Z_DUAL_STEPPER_DRIVERS) && DISABLED(Z_DUAL_ENDSTOPS) )
