...
#endif
#if defined (A) && defined (MOTOR_CURRENT_PWM_XY_PIN) || defined (B) && defined (MOTOR_CURRENT_PWM_XY_PIN)
...
#endif
#if defined (B) && defined(ARDUINO_ARCH_AVR)
    // --------------------------------------------------------------------------
#endif
#if defined (A)
...
() {
    ...
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (A) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (B) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT))
        if
...
#if defined (A) && defined (Z_LATE_ENABLE) || defined (B) && defined (Z_LATE_ENABLE)
        if
