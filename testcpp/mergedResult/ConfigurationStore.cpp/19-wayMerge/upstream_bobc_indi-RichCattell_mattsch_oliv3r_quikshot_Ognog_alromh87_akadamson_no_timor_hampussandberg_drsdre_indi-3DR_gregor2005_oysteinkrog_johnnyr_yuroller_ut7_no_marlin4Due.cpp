#if defined (upstream) || defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (oliv3r) || defined (quikshot) || defined (Ognog) || defined (alromh87) || defined (akadamson) || defined (hampussandberg) || defined (drsdre) || defined (indi-3DR) || defined (gregor2005) || defined (oysteinkrog) || defined (johnnyr) || defined (yuroller) || defined (ut7)
    #include "Marlin.h"
    #include "planner.h"
...
#endif
#if defined (mattsch) || defined (hampussandberg) || defined (ut7)
    #define EEPROM_VERSION "V10"
#endif
#if defined (mattsch) && defined (DELTA) || defined (hampussandberg) && defined (DELTA) || defined (ut7) && defined (DELTA)
...
#endif
#if defined (bobc) && defined (DELTA) || defined (mattsch) && defined (DELTA) || defined (oliv3r) || defined (quikshot) && defined (DELTA) || defined (Ognog) && defined (DELTA) || defined (alromh87) && defined (DELTA) || defined (hampussandberg) && defined (DELTA) || defined (johnnyr) && defined (DELTA) || defined (ut7) && defined (DELTA)
...
#endif
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (mattsch) && defined (EEPROM_SETTINGS) || defined (oysteinkrog) && defined (EEPROM_SETTINGS) || defined (yuroller) && defined (EEPROM_SETTINGS) || defined (ut7) && defined (EEPROM_SETTINGS)
    EEPROM_WRITE_VAR(i,add_homing);
#endif
#if defined (upstream) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (bobc) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (mattsch) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (quikshot) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (Ognog) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (alromh87) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (hampussandberg) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (oysteinkrog) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (johnnyr) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (yuroller) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (ut7) && (defined (DELTA) && defined (EEPROM_SETTINGS) )
    EEPROM_WRITE_VAR(i,endstop_adj);
#endif
#if defined (upstream) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (bobc) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (mattsch) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (quikshot) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (Ognog) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (alromh87) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (hampussandberg) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (oysteinkrog) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (johnnyr) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (yuroller) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (ut7) && (defined (DELTA) && defined (EEPROM_SETTINGS) )
...
#endif
#if defined (upstream) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (bobc) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (mattsch) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (oliv3r) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (quikshot) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (Ognog) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (alromh87) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (hampussandberg) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (gregor2005) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (oysteinkrog) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (johnnyr) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (yuroller) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (ut7) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) )
    float dummy = 3000.0f;
#endif
#if defined (akadamson) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (drsdre) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (indi-3DR) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) )
...
#endif
#if defined (upstream) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (bobc) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (mattsch) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (quikshot) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (Ognog) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (alromh87) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (hampussandberg) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (oysteinkrog) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (johnnyr) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (yuroller) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (ut7) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) )
    int lcd_contrast = 32;
#endif
#if defined (oliv3r) && (defined (EEPROM_SETTINGS) && defined (ENABLE_ULTILCD2) )
    EEPROM_WRITE_VAR(i,led_brightness_level);
#endif
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (bobc) && defined (EEPROM_SETTINGS) || defined (indi-RichCattell) && defined (EEPROM_SETTINGS) || defined (mattsch) && defined (EEPROM_SETTINGS) || defined (quikshot) && defined (EEPROM_SETTINGS) || defined (Ognog) && defined (EEPROM_SETTINGS) || defined (alromh87) && defined (EEPROM_SETTINGS) || defined (hampussandberg) && defined (EEPROM_SETTINGS) || defined (oysteinkrog) && defined (EEPROM_SETTINGS) || defined (johnnyr) && defined (EEPROM_SETTINGS) || defined (yuroller) && defined (EEPROM_SETTINGS) || defined (ut7) && defined (EEPROM_SETTINGS)
    EEPROM_WRITE_VAR(i,lcd_contrast);
#endif
#if defined (oliv3r) && (defined (EEPROM_SETTINGS) && defined (ENABLE_ULTILCD2) )
    EEPROM_WRITE_VAR(i,led_mode);
#endif
#if defined (upstream) && (defined (SCARA) && defined (EEPROM_SETTINGS) ) || defined (mattsch) && (defined (SCARA) && defined (EEPROM_SETTINGS) ) || defined (hampussandberg) && (defined (SCARA) && defined (EEPROM_SETTINGS) ) || defined (oysteinkrog) && (defined (SCARA) && defined (EEPROM_SETTINGS) ) || defined (yuroller) && (defined (SCARA) && defined (EEPROM_SETTINGS) ) || defined (ut7) && (defined (SCARA) && defined (EEPROM_SETTINGS) )
...
// Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
...
#if defined (upstream) && !defined (DISABLE_M503) || defined (mattsch) && !defined (DISABLE_M503) || defined (hampussandberg) && !defined (DISABLE_M503) || defined (oysteinkrog) && !defined (DISABLE_M503) || defined (yuroller) && !defined (DISABLE_M503) || defined (ut7) && !defined (DISABLE_M503)
    SERIAL_ECHO_START;
#endif
#if defined (upstream) && !defined (DISABLE_M503) || defined (mattsch) && !defined (DISABLE_M503) || defined (oysteinkrog) && !defined (DISABLE_M503) || defined (yuroller) && !defined (DISABLE_M503)
    ...
    SERIAL_ECHOPAIR(" Z",axis_steps_per_unit[2]);
#endif
#if defined (upstream) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (mattsch) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (oysteinkrog) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (yuroller) && (defined (SCARA) && !defined (DISABLE_M503) )
...
#endif
#if defined (upstream) && !defined (DISABLE_M503) || defined (bobc) && !defined (DISABLE_M503) || defined (indi-RichCattell) && defined (EEPROM_CHITCHAT) || defined (mattsch) && !defined (DISABLE_M503) || defined (oliv3r) && defined (EEPROM_CHITCHAT) || defined (quikshot) && !defined (DISABLE_M503) || defined (Ognog) && !defined (DISABLE_M503) || defined (alromh87) && !defined (DISABLE_M503) || defined (hampussandberg) && !defined (DISABLE_M503) || defined (gregor2005) && defined (EEPROM_CHITCHAT) || defined (oysteinkrog) && !defined (DISABLE_M503) || defined (johnnyr) && !defined (DISABLE_M503) || defined (yuroller) && !defined (DISABLE_M503) || defined (ut7) && !defined (DISABLE_M503)
...
#endif
#if defined (upstream) && !defined (DISABLE_M503) || defined (bobc) && !defined (DISABLE_M503) || defined (indi-RichCattell) && defined (EEPROM_CHITCHAT) || defined (mattsch) && !defined (DISABLE_M503) || defined (quikshot) && !defined (DISABLE_M503) || defined (Ognog) && !defined (DISABLE_M503) || defined (alromh87) && !defined (DISABLE_M503) || defined (hampussandberg) && !defined (DISABLE_M503) || defined (oysteinkrog) && !defined (DISABLE_M503) || defined (johnnyr) && !defined (DISABLE_M503) || defined (yuroller) && !defined (DISABLE_M503) || defined (ut7) && !defined (DISABLE_M503)
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (bobc) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (indi-RichCattell) && (defined (EEPROM_CHITCHAT) && defined (DELTA) ) || defined (mattsch) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (quikshot) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (Ognog) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (alromh87) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (hampussandberg) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (oysteinkrog) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (johnnyr) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (yuroller) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (ut7) && (defined (DELTA) && !defined (DISABLE_M503) )
    SERIAL_ECHO_START;
#endif
#if defined (indi-RichCattell) && (defined (EEPROM_CHITCHAT) && defined (DELTA) )
    SERIAL_ECHOLNPGM("Endstop adjustment (mm):");
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (bobc) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (mattsch) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (quikshot) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (Ognog) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (alromh87) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (hampussandberg) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (oysteinkrog) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (johnnyr) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (yuroller) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (ut7) && (defined (DELTA) && !defined (DISABLE_M503) )
    SERIAL_ECHOLNPGM("Endstop adjustement (mm):");
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (bobc) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (indi-RichCattell) && (defined (EEPROM_CHITCHAT) && defined (DELTA) ) || defined (mattsch) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (quikshot) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (Ognog) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (alromh87) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (hampussandberg) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (oysteinkrog) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (johnnyr) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (yuroller) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (ut7) && (defined (DELTA) && !defined (DISABLE_M503) )
    SERIAL_ECHO_START;
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (mattsch) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (oysteinkrog) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (yuroller) && (defined (DELTA) && !defined (DISABLE_M503) )
...
#endif
#if defined (upstream) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (bobc) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (indi-RichCattell) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) ) || defined (mattsch) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (oliv3r) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) ) || defined (quikshot) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (Ognog) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (alromh87) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (hampussandberg) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (gregor2005) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) ) || defined (oysteinkrog) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (johnnyr) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (yuroller) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (ut7) && (defined (PIDTEMP) && !defined (DISABLE_M503) )
...
#endif
#if defined (upstream) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (mattsch) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (oysteinkrog) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (yuroller) && (defined (PIDTEMP) && !defined (DISABLE_M503) )
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (!defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (mattsch) && (!defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (oysteinkrog) && (!defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (yuroller) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
...
//read stored version
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (bobc) && (defined (VERBOSE) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && defined (EEPROM_SETTINGS) || defined (mattsch) && defined (EEPROM_SETTINGS) || defined (oliv3r) && defined (EEPROM_SETTINGS) || defined (quikshot) && defined (EEPROM_SETTINGS) || defined (Ognog) && defined (EEPROM_SETTINGS) || defined (alromh87) && defined (EEPROM_SETTINGS) || defined (akadamson) && defined (EEPROM_SETTINGS) || defined (hampussandberg) && defined (EEPROM_SETTINGS) || defined (drsdre) && defined (EEPROM_SETTINGS) || defined (indi-3DR) && defined (EEPROM_SETTINGS) || defined (gregor2005) && defined (EEPROM_SETTINGS) || defined (oysteinkrog) && defined (EEPROM_SETTINGS) || defined (johnnyr) && defined (EEPROM_SETTINGS) || defined (yuroller) && defined (EEPROM_SETTINGS) || defined (ut7) && defined (EEPROM_SETTINGS)
...
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (bobc) && defined (EEPROM_SETTINGS) || defined (indi-RichCattell) && defined (EEPROM_SETTINGS) || defined (mattsch) && defined (EEPROM_SETTINGS) || defined (oliv3r) && defined (EEPROM_SETTINGS) || defined (quikshot) && defined (EEPROM_SETTINGS) || defined (Ognog) && defined (EEPROM_SETTINGS) || defined (alromh87) && defined (EEPROM_SETTINGS) || defined (hampussandberg) && defined (EEPROM_SETTINGS) || defined (gregor2005) && defined (EEPROM_SETTINGS) || defined (oysteinkrog) && defined (EEPROM_SETTINGS) || defined (johnnyr) && defined (EEPROM_SETTINGS) || defined (yuroller) && defined (EEPROM_SETTINGS) || defined (ut7) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (upstream) || defined (mattsch) || defined (hampussandberg) || defined (oysteinkrog) || defined (yuroller) || defined (ut7)
    for (short i=0; i<4; i++) {
        axis_steps_per_unit[i]=tmp1[i];
        max_feedrate[i]=tmp2[i];
        max_acceleration_units_per_sq_second[i]=tmp3[i];
...
#endif
#if defined (upstream) || defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (oliv3r) || defined (quikshot) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (gregor2005) || defined (oysteinkrog) || defined (johnnyr) || defined (yuroller) || defined (ut7)
...
#endif
#if defined (upstream) || defined (mattsch) || defined (oysteinkrog) || defined (yuroller)
...
#endif
#if defined (upstream) && defined (DELTA) || defined (mattsch) && defined (DELTA) || defined (oysteinkrog) && defined (DELTA) || defined (yuroller) && defined (DELTA)
