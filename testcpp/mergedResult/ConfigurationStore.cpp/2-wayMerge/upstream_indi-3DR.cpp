...
#endif
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (indi-3DR) && defined (EEPROM_SETTINGS)
...
// invalidate data first
...
#endif
#if defined (indi-3DR) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (upstream) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) ) || defined (indi-3DR) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) )
...
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (indi-3DR) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) )
    ...
    float dummy = 3000.0f;
#endif
#if defined (indi-3DR) && (!defined (PIDTEMP) && defined (EEPROM_SETTINGS) )
...
// validate data
    ...
    //EEPROM_SETTINGS
#endif
#if defined (upstream) && !defined (DISABLE_M503) || defined (indi-3DR) && defined (EEPROM_CHITCHAT)
...
// Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
...
#endif
#if defined (indi-3DR) && defined (EEPROM_CHITCHAT)
...
#endif
#if defined (upstream) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (indi-3DR) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHOLN("");
    SERIAL_ECHO_START;
#endif
...
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (indi-3DR) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHO_START;
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) )
    ...
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (indi-3DR) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHO_START;
...
#endif
#if defined (indi-3DR) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
...
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (indi-3DR) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
...
#if defined (upstream) && (defined (EEPROM_CHITCHAT) && defined (EEPROM_SETTINGS) ) || defined (indi-3DR) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (upstream) && defined (ULTIPANEL) || defined (indi-3DR) && defined (ULTIPANEL)
...
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (indi-3DR) && defined (PIDTEMP)
    Kp = DEFAULT_Kp;
#endif
#if defined (upstream) && defined (PIDTEMP)
    Ki = scalePID_i(DEFAULT_Ki);
#endif
#if defined (indi-3DR) && defined (PIDTEMP)
...
// call updatePID (similar to when we have processed M301)
    updatePID();
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) ) || defined (indi-3DR) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) )
    Kc = DEFAULT_Kc;
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (indi-3DR) && defined (PIDTEMP)
