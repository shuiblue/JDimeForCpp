...
#endif
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (indi-RichCattell) && defined (EEPROM_SETTINGS)
...
// invalidate data first
...
#endif
#if defined (upstream) && (defined (DELTA) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && (defined (DELTA) && defined (EEPROM_SETTINGS) )
...
#endif
#if defined (upstream) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) )
...
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) )
    ...
    EEPROM_WRITE_VAR(i,dummy);
#endif
#if defined (upstream) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && (!defined (DOGLCD) && defined (EEPROM_SETTINGS) )
    int lcd_contrast = 32;
#endif
...
// Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
...
#endif
    SERIAL_ECHOLN("");
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (indi-RichCattell) && (defined (EEPROM_CHITCHAT) && defined (DELTA) )
    SERIAL_ECHO_START;
#endif
    ...
    */
#endif
#if defined (upstream) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (indi-RichCattell) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHO_START;
...
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (indi-RichCattell) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
...
#if defined (upstream) && (defined (EEPROM_CHITCHAT) && defined (EEPROM_SETTINGS) ) || defined (indi-RichCattell) && defined (EEPROM_SETTINGS)
...
// steps per sq second need to be updated to agree with the units per sq second
    ...
    set_delta_constants();
#endif
#if defined (upstream) && defined (ULTIPANEL) || defined (indi-RichCattell) && defined (ULTIPANEL)
...
#endif
#if defined (upstream) && defined (DOGLCD) || defined (indi-RichCattell) && defined (DOGLCD)
    lcd_contrast = DEFAULT_LCD_CONTRAST;
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (indi-RichCattell) && defined (PIDTEMP)
    Kp = DEFAULT_Kp;
...
// call updatePID (similar to when we have processed M301)
    updatePID();
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) ) || defined (indi-RichCattell) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) )
    Kc = DEFAULT_Kc;
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (indi-RichCattell) && defined (PIDTEMP)
