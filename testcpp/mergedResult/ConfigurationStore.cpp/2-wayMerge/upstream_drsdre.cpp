...
#endif
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (drsdre) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (upstream) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) ) || defined (drsdre) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) )
...
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (drsdre) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) )
...
// validate data
    ...
    //EEPROM_SETTINGS
#endif
#if defined (upstream) && !defined (DISABLE_M503) || defined (drsdre) && defined (EEPROM_CHITCHAT)
...
// Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
...
#endif
#if defined (upstream) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (drsdre) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHOLN("");
    SERIAL_ECHO_START;
#endif
...
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (drsdre) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHO_START;
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) )
    ...
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (drsdre) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHO_START;
...
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (drsdre) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
...
#if defined (upstream) && (defined (EEPROM_CHITCHAT) && defined (EEPROM_SETTINGS) ) || defined (drsdre) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (upstream) && defined (ULTIPANEL) || defined (drsdre) && defined (ULTIPANEL)
...
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (drsdre) && defined (PIDTEMP)
    Kp = DEFAULT_Kp;
#endif
...
// call updatePID (similar to when we have processed M301)
    updatePID();
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) ) || defined (drsdre) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) )
    Kc = DEFAULT_Kc;
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (drsdre) && defined (PIDTEMP)
