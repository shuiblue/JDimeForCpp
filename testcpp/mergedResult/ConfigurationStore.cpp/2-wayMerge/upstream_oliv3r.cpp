...
#endif
#if defined (upstream) && defined (EEPROM_SETTINGS) || defined (oliv3r) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (upstream) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) ) || defined (oliv3r) && (!defined (ULTIPANEL) && defined (EEPROM_SETTINGS) )
...
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) ) || defined (oliv3r) && (defined (PIDTEMP) && defined (EEPROM_SETTINGS) )
...
// Add scaling for SCARA
    ...
    EEPROM_WRITE_VAR(i,dummyByte);
#endif
#if defined (upstream) && (defined (EEPROM_SETTINGS) && defined (FWRETRACT) ) || defined (oliv3r) && defined (EEPROM_SETTINGS)
...
// validate data
    ...
    //EEPROM_SETTINGS
#endif
#if defined (upstream) && !defined (DISABLE_M503) || defined (oliv3r) && defined (EEPROM_CHITCHAT)
...
// Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
...
#endif
#if defined (oliv3r) && defined (EEPROM_CHITCHAT)
...
#endif
#if defined (upstream) && (defined (SCARA) && !defined (DISABLE_M503) ) || defined (oliv3r) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHOLN("");
    SERIAL_ECHO_START;
#endif
...
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) ) || defined (oliv3r) && defined (EEPROM_CHITCHAT)
    SERIAL_ECHO_START;
#endif
#if defined (upstream) && (defined (DELTA) && !defined (DISABLE_M503) )
    ...
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (defined (PIDTEMP) && !defined (DISABLE_M503) ) || defined (oliv3r) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHO_START;
...
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DISABLE_M503) && defined (FWRETRACT) ) || defined (oliv3r) && (defined (EEPROM_CHITCHAT) && defined (PIDTEMP) )
    SERIAL_ECHOLN("");
#endif
#if defined (upstream) && (!defined (DISABLE_M503) && defined (FWRETRACT) )
    SERIAL_ECHO_START;
...
#endif
#if defined (upstream) && (defined (EEPROM_CHITCHAT) && defined (EEPROM_SETTINGS) ) || defined (oliv3r) && defined (EEPROM_SETTINGS)
...
#endif
#if defined (upstream) && defined (ULTIPANEL) || defined (oliv3r) && defined (ULTIPANEL)
...
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (oliv3r) && defined (PIDTEMP)
    Kp = DEFAULT_Kp;
...
// call updatePID (similar to when we have processed M301)
    updatePID();
#endif
#if defined (upstream) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) ) || defined (oliv3r) && (defined (PIDTEMP) && defined (PID_ADD_EXTRUSION_RATE) )
    Kc = DEFAULT_Kc;
#endif
#if defined (upstream) && defined (PIDTEMP) || defined (oliv3r) && defined (PIDTEMP)
