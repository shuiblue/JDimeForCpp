    ...
    #include "qr_solve.h"
#endif
#if defined (upstream) && defined (AUTO_BED_LEVELING_GRID) || defined (bobc) && defined (AUTO_BED_LEVELING_GRID) || defined (mattsch) && defined (AUTO_BED_LEVELING_GRID) || defined (quikshot) && defined (AUTO_BED_LEVELING_GRID) || defined (ErikZalm) && defined (AUTO_BED_LEVELING_GRID) || defined (Ognog) && defined (AUTO_BED_LEVELING_GRID) || defined (alromh87) && defined (AUTO_BED_LEVELING_GRID) || defined (hampussandberg) && defined (AUTO_BED_LEVELING_GRID) || defined (oysteinkrog) && defined (AUTO_BED_LEVELING_GRID) || defined (johnnyr) && defined (AUTO_BED_LEVELING_GRID) || defined (yuroller) && defined (AUTO_BED_LEVELING_GRID) || defined (ut7) && defined (AUTO_BED_LEVELING_GRID) || defined (marlin4Due) && defined (AUTO_BED_LEVELING_GRID)
#include <stdlib.h>
#include <math.h>
//# include "r8lib.h"
int i4_min
...
/******************************************************************************/
void dqrank
( double a[], int lda, int m, int n, double tol, int *kr,
...
/******************************************************************************/
void dqrdc
( double a[], int lda, int n, int p, double qraux[], int jpvt[],
  double work[], int job )
/******************************************************************************/
/*
  Purpose:
...
/******************************************************************************/
int dqrls
( double a[], int lda, int m, int n, double tol, int *kr, double b[],
...
/******************************************************************************/
void dqrlss
( double a[], int lda, int m, int n, int kr, double b[], double x[],
...
/******************************************************************************/
int dqrsl
( double a[], int lda, int n, int k, double qraux[], double y[],
