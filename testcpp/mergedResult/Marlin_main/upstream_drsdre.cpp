...
#include "Marlin.h"
    ...
    #include "Servo.h"
#endif
#if defined (A) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (B) && DIGIPOTSS_PIN > -1
    #include <SPI.h>
#endif
#if defined (A)
...
#endif
#if defined (A) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (B) &&  KILL_PIN>-1 )
    WRITE(KILL_PIN,HIGH);
#endif
}
...
void setup_photpin
() {
#if defined (A) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (B) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) )
...
#endif
#if defined (A) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (B) && (PS_ON_PIN > -1)
    SET_OUTPUT(PS_ON_PIN);
#endif
#if defined (A) && (defined(PS_DEFAULT_OFF) && (defined(PS_ON_PIN) && PS_ON_PIN > -1 &)
    WRITE(PS_ON_PIN, PS_ON_ASLEEP);
#endif
#if defined (A) && ((defined(PS_ON_PIN) && PS_ON_PIN > -1 && )!defined(PS_DEFAULT_OFF) ) || defined (B) && (PS_ON_PIN > -1)
...
#endif
#if defined (A) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1)
...
//DUAL_X_CARRIAGE
#endif
#if defined (A) && (! (defined DELTA || defined SCARA)) || defined (B)
...
#if defined (A) && (defined(FAN_PIN) && CONTROLLERFAN_PIN == FAN_PIN && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1 &)
    #error "You cannot set CONTROLLERFAN_PIN equal to FAN_PIN"
#endif
#if defined (A) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (B) && defined (CONTROLLERFAN_PIN)
