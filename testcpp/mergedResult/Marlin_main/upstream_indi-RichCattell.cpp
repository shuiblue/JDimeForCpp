...
#endif
#if defined (A) && (!defined (PS_DEFAULT_OFF) && defined (ULTIPANEL) ) || defined (B) && defined (ULTIPANEL)
...
#endif
#if defined (A) && (defined(PS_DEFAULT_OFF) && (defined(PS_ON_PIN) && PS_ON_PIN > -1 &)
    WRITE(PS_ON_PIN, PS_ON_ASLEEP);
#endif
#if defined (A) && ((defined(PS_ON_PIN) && PS_ON_PIN > -1 && )!defined(PS_DEFAULT_OFF) ) || defined (B) && (defined(PS_ON_PIN) && PS_ON_PIN > -1)
...
#endif
#if defined (A) && defined (DIGIPOT_I2C)
    digipot_i2c_init();
#endif
...
#if defined (A) && (EXTRUDERS > 1 && defined (DELTA) )
            calculate_delta(current_position);
#endif
#if defined (A) && (EXTRUDERS > 1 && defined (DELTA) )
...
//sent position to plan_set_position();
            ...
            plan_set_position(delta[X_AXIS], delta[Y_AXIS], delta[Z_AXIS],current_position[E_AXIS]);
#endif
#if defined (A) && (EXTRUDERS > 1 && !defined (DELTA) ) || defined (B) && EXTRUDERS > 1
            plan_set_position(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS]);
#endif
...
#endif
#if defined (A) && defined (TEMP_STAT_LEDS)
