...
/* -*- c++ -*- */
    ...
    */
    ...
    #include "Marlin.h"
#endif
#if defined (A) && defined (ENABLE_AUTO_BED_LEVELING) || defined (B) && ENABLED(ENABLE_AUTO_BED_LEVELING)
    #include "vector_3.h"
#endif
#if defined (A) && (defined (ENABLE_AUTO_BED_LEVELING) && defined (AUTO_BED_LEVELING_GRID) ) || defined (B) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(AUTO_BED_LEVELING_GRID) )
    #include "qr_solve.h"
#endif
#if defined (A) || defined (B)
    // ENABLE_AUTO_BED_LEVELING
#endif
#if defined (B) && ENABLED(MESH_BED_LEVELING)
    ...
    #include "buzzer.h"
#endif
#if defined (B) && ENABLED(BLINKM)
    #include "blinkm.h"
#endif
#if defined (A) && defined (BLINKM) || defined (B) && ENABLED(BLINKM)
    #include "Wire.h"
#endif
#if defined (A) && NUM_SERVOS > 0
    #include "Servo.h"
#endif
#if defined (B) && HAS_SERVOS
    #include "servo.h"
#endif
#if defined (A) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (B) && HAS_DIGIPOTSS
    #include <SPI.h>
#endif
#if defined (A)
    ...
    */
...
#endif
#if defined (B) && ENABLED(M100_FREE_MEMORY_WATCHER)
    void gcode_M100();
#endif
#if defined (A)
    // http://objects.reprap.org/wiki/Mendel_User_Manual:_RepRapGCodes
    ...
    //===========================================================================
#endif
#if defined (A) && defined (SDSUPPORT) || defined (B) && ENABLED(SDSUPPORT)
    CardReader card;
#endif
#if defined (A)
...
// Extruder offset
#endif
#if defined (A) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) )
...
float extruder_offset[NUM_EXTRUDER_OFFSETS][EXTRUDERS] = {
    ...
    int fanSpeed=0;
#endif
#if defined (A) && defined (SERVO_ENDSTOPS)
...
#endif
#if defined (B) && ENABLED(ENABLE_AUTO_BED_LEVELING)
    int xy_travel_speed = XY_TRAVEL_SPEED;
    float zprobe_zoffset = Z_PROBE_OFFSET_FROM_EXTRUDER;
#endif
#if defined (B) && (ENABLED(Z_DUAL_ENDSTOPS) && DISABLED(DELTA))
    float z_endstop_adj = 0;
#endif
#if defined (B)
    // Extruder offsets
#endif
#if defined (B) && (EXTRUDERS > 1 && !defined (EXTRUDER_OFFSET_X) )
    #define EXTRUDER_OFFSET_X { 0 }
#endif
#if defined (B) && (EXTRUDERS > 1 && !defined (EXTRUDER_OFFSET_Y) )
    #define EXTRUDER_OFFSET_Y { 0 }
#endif
#if defined (B) && EXTRUDERS > 1
...
#endif
#if defined (B) && HAS_SERVO_ENDSTOPS
    const int servo_endstop_id[] = SERVO_ENDSTOP_IDS;
    const int servo_endstop_angle[][2] = SERVO_ENDSTOP_ANGLES;
#endif
#if defined (A) && defined (BARICUDA) || defined (B) && ENABLED(BARICUDA)
    int ValvePressure=0;
    int EtoPPressure=0;
#endif
#if defined (A) && defined (FWRETRACT) || defined (B) && ENABLED(FWRETRACT)
...
#endif
#if defined (B) && ENABLED(FWRETRACT)
bool retracted[EXTRUDERS] = { false };
#endif
#if defined (A) && defined (FWRETRACT)
...
bool retracted_swap[EXTRUDERS] = { false };
    ...
    // FWRETRACT
#endif
#if defined (A) && (!defined (PS_DEFAULT_OFF) && defined (ULTIPANEL) )
    bool powersupply = true;
#endif
#if defined (B) && (ENABLED(ULTIPANEL) && HAS_POWER_SWITCH)
    bool powersupply =
...
#endif
#if defined (B) && ENABLED(DELTA)
float delta[3] = { 0 };
#endif
#if defined (A) && defined (DELTA) || defined (B) && ENABLED(DELTA)
...
float endstop_adj[3] = { 0 };
    ...
    // Build size scaling
#endif
#if defined (B) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(DELTA) )
...
#endif
#if defined (B) && ENABLED(SCARA)
float delta_segments_per_second = SCARA_SEGMENTS_PER_SECOND;
static float delta[3] = { 0 };
#endif
#if defined (A) && defined (SCARA) || defined (B) && ENABLED(SCARA)
...
// Build size scaling, default to 1
    ...
    bool cancel_heatup = false ;
#endif
#if defined (A) && defined (FILAMENT_SENSOR) || defined (B) && ENABLED(FILAMENT_SENSOR)
    ...
    const char errormagic[] PROGMEM = "Error:";
#endif
#if defined (B) && ENABLED(FILAMENT_RUNOUT_SENSOR)
...
#endif
#if defined (A) || defined (B) && ENABLED(SDSUPPORT)
...
#endif
#if defined (B) && ENABLED(PREVENT_DANGEROUS_EXTRUDE)
    float extrude_min_temp = EXTRUDE_MINTEMP;
#endif
#if defined (B) && defined (__AVR__)
    // HAL for Due
#endif
#if defined (A) && defined (SDSUPPORT) || defined (B) && (defined (SDSUPPORT) && defined (__AVR__) )
#include "SdFatUtil.h"
int freeMemory
() {
...
#endif
#if defined (A) || defined (B) && defined (__AVR__)
    //!SDSUPPORT
#endif
#if defined (A)
...
void setup_killpin
() {
#if defined (A) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (B) && HAS_KILL
    SET_INPUT(KILL_PIN);
#endif
#if defined (A)
    WRITE(KILL_PIN,HIGH);
...
void setup_homepin
(void) {
#if defined (A) && (defined(HOME_PIN) && HOME_PIN > -1) || defined (B) && HAS_HOME
    SET_INPUT(HOME_PIN);
#endif
#if defined (A)
    WRITE(HOME_PIN,HIGH);
...
#error "TODO: enter initalisation code for more servos"
    ...
    servo[1].detach();
#endif
#if defined (B) && (NUM_SERVOS >= 3 && HAS_SERVO_2)
    servo[2].attach(SERVO2_PIN);
    servo[2].detach();
#endif
#if defined (B) && (NUM_SERVOS >= 4 && HAS_SERVO_3)
...
// Set position of Servo Endstops that are defined
...
#endif
#if defined (A) && (defined (ENABLE_AUTO_BED_LEVELING) && (PROBE_SERVO_DEACTIVATION_DELAY > 0))
    ...
    */
#endif
#if defined (B) && HAS_STEPPER_RESET
...
#endif
#if defined (A) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (B) && (defined (STRING_DISTRIBUTION_DATE) && defined (STRING_CONFIG_H_AUTHOR) )
    SERIAL_ECHO_START;
...
#endif
#if defined (B) && defined (STRING_DISTRIBUTION_DATE)
...
// STRING_DISTRIBUTION_DATE
    ...
    for(int8_t i = 0; i < BUFSIZE; i++) {
        ...
        fromsd[i] = false;
#endif
#if defined (B) && ENABLED(SDSUPPORT)
        fromsd[i] = false;
#endif
    }
#endif
...
// wait 1sec to display the splash screen
#endif
#if defined (A) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (B) && HAS_CONTROLLERFAN
...
#endif
#if defined (A) && defined (DIGIPOT_I2C) || defined (B) && ENABLED(DIGIPOT_I2C)
    digipot_i2c_init();
#endif
#if defined (A)
...
#endif
#if defined (A) && defined (Z_PROBE_SLED) || defined (B) && ENABLED(Z_PROBE_SLED)
// turn it off
#endif
// Z_PROBE_SLED
    setup_homepin();
#if defined (B) && defined (STAT_LED_RED)
    pinMode(STAT_LED_RED, OUTPUT);
    digitalWrite(STAT_LED_RED, LOW);
// turn it off
#endif
#if defined (B) && defined (STAT_LED_BLUE)
...
#endif
#if defined (B) && ENABLED(NO_TIMEOUTS)
...
#endif
#if defined (A) && (defined (DUAL_X_CARRIAGE) && (X_HOME_DIR != -1 || X2_HOME_DIR != 1 &)
    #error "Please use canonical x-carriage assignment"
    // the x-carriages are defined by their homing directions
#endif
#if defined (A) && defined (DUAL_X_CARRIAGE) || defined (B) && ENABLED(DUAL_X_CARRIAGE)
...
#endif
#if defined (B) && ENABLED(DUAL_X_CARRIAGE)
...
#endif
#if defined (B) && (ENABLED(DELTA) || ENABLED(SCARA))
...
#endif
#if defined (A) && (defined (ENABLE_AUTO_BED_LEVELING) && defined (AUTO_BED_LEVELING_GRID) ) || defined (B) && (DISABLED(DELTA) && ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(AUTO_BED_LEVELING_GRID) )
...
#endif
#if defined (A) && (!defined (AUTO_BED_LEVELING_GRID) && defined (ENABLE_AUTO_BED_LEVELING) )
    // not AUTO_BED_LEVELING_GRID
#endif
#if defined (B) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(AUTO_BED_LEVELING_GRID) )
    // !DELTA
#endif
#if defined (B) && (!ENABLED(AUTO_BED_LEVELING_GRID) && ENABLED(ENABLE_AUTO_BED_LEVELING) )
    // !AUTO_BED_LEVELING_GRID
#endif
#if defined (A) && (!defined (AUTO_BED_LEVELING_GRID) && defined (ENABLE_AUTO_BED_LEVELING) ) || defined (B) && (!ENABLED(AUTO_BED_LEVELING_GRID) && ENABLED(ENABLE_AUTO_BED_LEVELING) )
...
#endif
#if defined (B) && (!ENABLED(DELTA) && ENABLED(ENABLE_AUTO_BED_LEVELING) )
// !DELTA
#endif
#if defined (A) && defined (ENABLE_AUTO_BED_LEVELING) || defined (B) && (!ENABLED(DELTA) && ENABLED(ENABLE_AUTO_BED_LEVELING) )
    plan_bed_level_matrix.set_to_identity();
...
() {
#if defined (A) && (defined (ENDSTOPS_ONLY_FOR_HOMING) && defined (ENABLE_AUTO_BED_LEVELING) ) || defined (B) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(ENDSTOPS_ONLY_FOR_HOMING) )
...
#endif
#if defined (B) && (!defined (SLED_DOCKING_OFFSET) && ENABLED(Z_PROBE_SLED) )
    #define SLED_DOCKING_OFFSET 0
#endif
#if defined (A) && defined (Z_PROBE_SLED)
    //
#endif
#if defined (B) && ENABLED(Z_PROBE_SLED)
    /**
    * Method to dock/undock a sled designed by Charles Bell.
    *
    * dock[in]     If true, move to MAX_X and engage the electromagnet
...
#endif
#if defined (B) && (ENABLED(Z_PROBE_SLED) && Z_RAISE_AFTER_PROBING > 0 )
// raise Z
#endif
#if defined (B) && ENABLED(Z_PROBE_SLED)
...
#endif
#if defined (B) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && DISABLED(Z_PROBE_SLED) )
...
#endif
#if defined (B) && ENABLED(ULTIPANEL)
/**
...
#endif
#if defined (B) && (ENABLED(SDSUPPORT) && ENABLED(LONG_FILENAME_HOST_SUPPORT) )
/**
...
#endif
#if defined (B) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(Z_PROBE_REPEATABILITY_TEST))
    // This is redundant since the SanityCheck.h already checks for a valid Z_PROBE_PIN, but here for clarity.
#endif
#if defined (B) && ((ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(Z_PROBE_REPEATABILITY_TEST) && )ENABLED(Z_PROBE_ENDSTOP) && !HAS_Z_PROBE )
    #error You must define Z_PROBE_PIN to enable Z-Probe repeatability calculation.
#endif
#if defined (B) && ((ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(Z_PROBE_REPEATABILITY_TEST) && )!HAS_Z_MIN )
...
#endif
#if defined (B) && (ENABLED(BARICUDA) && HAS_HEATER_1 )
/**
...
#endif
#if defined (B) && (ENABLED(BARICUDA) && HAS_HEATER_2 )
/**
...
#endif
#if defined (B) && ENABLED(Z_DUAL_ENDSTOPS)
...
inline void gcode_M301() {
    ...
    // PIDTEMP
#endif
#if defined (B) && ENABLED(PIDTEMPBED)
inline void gcode_M304() {
    ...
    // PIDTEMPBED
#endif
#if defined (B) && (defined(CHDK) || HAS_PHOTOGRAPH)
/**
...
inline void gcode_M240() {
    ...
    // CHDK || PHOTOGRAPH_PIN
#endif
#if defined (B) && ENABLED(HAS_LCD_CONTRAST)
/**
...
inline void gcode_M365() {
    ...
    // SCARA
#endif
#if defined (B) && ENABLED(EXT_SOLENOID)
...
#endif
#if defined (B) && ((ENABLED(ENABLE_AUTO_BED_LEVELING) && DISABLED(Z_PROBE_SLED) && (HAS_SERVO_ENDSTOPS || ENABLED(Z_PROBE_ALLEN_KEY)) && )HAS_SERVO_ENDSTOPS )
...
#endif
#if defined (B) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && DISABLED(Z_PROBE_SLED) && (HAS_SERVO_ENDSTOPS || ENABLED(Z_PROBE_ALLEN_KEY)))
/**
...
#endif
#if defined (B) && ENABLED(FILAMENT_SENSOR)
/**
...
#endif
#if defined (B) && ENABLED(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
/**
...
#endif
#if defined (B) && defined (CUSTOM_M_CODE_SET_Z_PROBE_OFFSET)
...
#endif
#if defined (B) && ENABLED(FILAMENTCHANGEENABLE)
/**
...
inline bool prepare_move_dual_x_carriage() {
    ...
    // DUAL_X_CARRIAGE
#endif
#if defined (B) && (DISABLED(DELTA) && DISABLED(SCARA))
...
#endif
#if defined (B) && HAS_CONTROLLERFAN
void controllerFan() {
...
void calculate_delta(float cartesian[3]) {
    ...
    */
    ...
    // SCARA
#endif
#if defined (B) && ENABLED(TEMP_STAT_LEDS)
static bool red_led = false;
...
#endif
#if defined (B) && ENABLED(FAST_PWM_FAN)
void setPwmFrequency(uint8_t pin, int val) {
    val &= 0x07;
    switch (digitalPinToTimer(pin)) {
#if defined(TCCR0A)
