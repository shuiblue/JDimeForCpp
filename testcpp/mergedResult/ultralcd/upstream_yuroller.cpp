...
static void lcd_goto_menu(menuFunc_t menu, const uint32_t encoder=0, const bool feedback=true) {
    ...
    () {
#if defined (A) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )defined (ULTRA_LCD) ) || defined (B) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )defined (ULTRA_LCD) )
        uint16_t mil = millis();
#endif
#if defined (A) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )defined (ULTRA_LCD) && !defined (PROGRESS_MSG_ONCE) ) || defined (B) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )defined (ULTRA_LCD) && !defined (PROGRESS_MSG_ONCE) )
        if
        (mil > progressBarTick + PROGRESS_BAR_MSG_TIME + PROGRESS_BAR_BAR_TIME) {
            progressBarTick = mil;
        }
#endif
#if defined (A) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )PROGRESS_MSG_EXPIRE > 0 && defined (ULTRA_LCD) ) || defined (B) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )PROGRESS_MSG_EXPIRE > 0 && defined (ULTRA_LCD) )
