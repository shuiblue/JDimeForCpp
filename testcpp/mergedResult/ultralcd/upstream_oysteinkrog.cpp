...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (FILAMENT_LCD_DISPLAY) ) || defined (B) && (defined (ULTRA_LCD) && defined (FILAMENT_LCD_DISPLAY) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (DOGLCD) ) || defined (B) && (defined (ULTRA_LCD) && !defined (DOGLCD) )
...
#endif
#if defined (A) && (defined (DOGLCD) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && (defined (DOGLCD) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (DELTA_CALIBRATION_MENU) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (DELTA_CALIBRATION_MENU) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined (ULTIPANEL) )
    #define ENCODER_STEPS_PER_MENU_ITEM 5
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_PULSES_PER_STEP) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_PULSES_PER_STEP) && defined (ULTIPANEL) )
    #define ENCODER_PULSES_PER_STEP 1
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (LCD_HAS_SLOW_BUTTONS) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (LCD_HAS_SLOW_BUTTONS) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) && defined (ULTIPANEL) )
...
#endif
#if defined (B) && defined (ULTRA_LCD)
    static void lcd_goto_menu(menuFunc_t menu, const uint32_t encoder=0, const bool feedback=true) {
        if (currentMenu != menu) {
            currentMenu = menu;
            encoderPosition = encoder;
        ...
        () {
#if defined (A) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )defined (ULTRA_LCD) ) || defined (B) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && !defined(DOGLCD) && )defined (ULTRA_LCD) )
            uint16_t mil = millis();
#endif
#if defined (A) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )defined (ULTRA_LCD) && !defined (PROGRESS_MSG_ONCE) ) || defined (B) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && !defined(DOGLCD) && )defined (ULTRA_LCD) && !defined (PROGRESS_MSG_ONCE) )
            if
            (mil > progressBarTick + PROGRESS_BAR_MSG_TIME + PROGRESS_BAR_BAR_TIME) {
                progressBarTick = mil;
            }
#endif
#if defined (A) && ((defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && )PROGRESS_MSG_EXPIRE > 0 && defined (ULTRA_LCD) ) || defined (B) && (PROGRESS_MSG_EXPIRE > 0 && (defined(LCD_PROGRESS_BAR) && defined(SDSUPPORT) && !defined(DOGLCD) && )defined (ULTRA_LCD) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (FILAMENT_LCD_DISPLAY) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (FILAMENT_LCD_DISPLAY) && defined (ULTIPANEL) )
                message_millis = millis();
// get status message to show up for a while
#endif
            }
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL_FEEDMULTIPLY) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL_FEEDMULTIPLY) && defined (ULTIPANEL) )
...
#if defined (A) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
            if
            (card.cardOK) {
                if
                (card.isFileOpen()) {
...
#if defined (A) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (B) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#if defined (A) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) )
            MENU_ITEM_EDIT(int3, MSG_NOZZLE, &target_temperature[0], 0, HEATER_0_MAXTEMP - 15);
#endif
#if defined (A) && (defined (ULTRA_LCD) && TEMP_SENSOR_1 != 0 && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && TEMP_SENSOR_1 != 0 && defined (ULTIPANEL) )
            MENU_ITEM_EDIT(int3, MSG_NOZZLE1, &target_temperature[1], 0, HEATER_1_MAXTEMP - 15);
#endif
#if defined (A) && (TEMP_SENSOR_2 != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && (TEMP_SENSOR_2 != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
            MENU_ITEM_EDIT(int3, MSG_NOZZLE2, &target_temperature[2], 0, HEATER_2_MAXTEMP - 15);
#endif
#if defined (A) && (TEMP_SENSOR_BED != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && (TEMP_SENSOR_BED != 0 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (BABYSTEP_XY) && defined (ULTIPANEL) ) || defined (B) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (BABYSTEP_XY) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) )
...
//3 extruder preheat
#endif
#if defined (A) && (defined (ULTRA_LCD) && (TEMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 && )defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && (TEMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 && )defined (ULTIPANEL) )
...
//2 extruder preheat
        ...
        () {
            START_MENU();
            MENU_ITEM(back, MSG_MAIN, lcd_main_menu);
#if defined (A) && (defined (ULTRA_LCD) && defined (MENU_ADDAUTOSTART) && defined (SDSUPPORT) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (MENU_ADDAUTOSTART) && defined (SDSUPPORT) && defined (ULTIPANEL) )
...
#if defined (A) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) && (TEMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_BED != 0 &) || defined (B) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) && (TEMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_BED != 0 &)
            MENU_ITEM(submenu, MSG_PREHEAT_PLA, lcd_preheat_pla_menu);
            MENU_ITEM(submenu, MSG_PREHEAT_ABS, lcd_preheat_abs_menu);
#endif
#if defined (A) && (defined (ULTRA_LCD) && (EMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_BED != 0 && )TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && (EMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_BED != 0 && )TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) )
            MENU_ITEM(function, MSG_PREHEAT_PLA, lcd_preheat_pla0);
            MENU_ITEM(function, MSG_PREHEAT_ABS, lcd_preheat_abs0);
#endif
            MENU_ITEM(function, MSG_COOLDOWN, lcd_cooldown);
#if defined (A) && (defined (ULTRA_LCD) && PS_ON_PIN > -1 && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && PS_ON_PIN > -1 && defined (ULTIPANEL) )
            if
            (powersupply) {
...
// DELTA_CALIBRATION_MENU
        ...
        (const char *name, int axis, int min, int max) {
            ...
            (encoderPosition != 0) {
                ...
                encoderPosition = 0;
#if defined (A) && (defined (ULTRA_LCD) && defined (DELTA) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (DELTA) && defined (ULTIPANEL) )
...
//    MENU_ITEM_EDIT(int3, MSG_CONTRAST, &lcd_contrast, 0, 63);
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) )
            MENU_ITEM(submenu, MSG_RETRACT, lcd_control_retract_menu);
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (EEPROM_SETTINGS) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (EEPROM_SETTINGS) && defined (ULTIPANEL) )
        ...
        static void lcd_control_temperature_menu
        () {
#if defined (A) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) )
...
#endif
            MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &fanSpeed, 0, 255);
#if defined (A) && (defined (ULTRA_LCD) && (defined AUTOTEMP && (TEMP_SENSOR_0 != 0) && )defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && (defined AUTOTEMP && (TEMP_SENSOR_0 != 0) && )defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined ( PID_ADD_EXTRUSION_RATE) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined ( PID_ADD_EXTRUSION_RATE) && defined (ULTIPANEL) )
...
//PIDTEMP
        ...
        () {
            START_MENU();
            MENU_ITEM(back, MSG_CONTROL, lcd_control_menu);
#if defined (A) && (defined (ULTRA_LCD) && defined (ENABLE_AUTO_BED_LEVELING) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (ENABLE_AUTO_BED_LEVELING) && defined (ULTIPANEL) )
...
#if defined (A) && (defined (ULTRA_LCD) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined (ULTIPANEL) )
            MENU_ITEM_EDIT(bool, MSG_ENDSTOP_ABORT, &abort_on_endstop_hit);
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (SCARA) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (SCARA) && defined (ULTIPANEL) )
...
#if defined (A) && (EXTRUDERS > 1 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && (EXTRUDERS > 1 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
                MENU_ITEM_EDIT_CALLBACK(float43, MSG_FILAMENT_SIZE_EXTRUDER_1, &filament_size[1], DEFAULT_NOMINAL_FILAMENT_DIA - .5, DEFAULT_NOMINAL_FILAMENT_DIA + .5, calculate_volumetric_multipliers);
#endif
#if defined (A) && (EXTRUDERS > 2 && EXTRUDERS > 1 && defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && (EXTRUDERS > 2 && EXTRUDERS > 1 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#if defined (A) && (EXTRUDERS > 1 && defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) ) || defined (B) && (EXTRUDERS > 1 && defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FWRETRACT) )
...
//FWRETRACT
#endif
#if defined (A) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && SDCARDDETECT == -1 && defined (ULTIPANEL) )
...
#endif
                lcd_buttons_update();
#if defined (A) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) ) || defined (B) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) )
                if
...
//manage encoder rotation
            ...
            bool lcd_detected
            (void) {
#if defined (A) && (defined (ULTRA_LCD) && ((defined(LCD_I2C_TYPE_MCP23017) || defined(LCD_I2C_TYPE_MCP23008)) && defined(DETECT_DEVICE) && )defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && ((defined(LCD_I2C_TYPE_MCP23017) || defined(LCD_I2C_TYPE_MCP23008)) && defined(DETECT_DEVICE) && )defined (ULTIPANEL) )
