...
#if defined (A) && (defined (ULTRA_LCD) && TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
        MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &fanSpeed, 0, 255);
#if defined (A) && (defined (ULTRA_LCD) && (defined AUTOTEMP && (TEMP_SENSOR_0 != 0) && )defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (AUTOTEMP) && defined (ULTIPANEL) )
