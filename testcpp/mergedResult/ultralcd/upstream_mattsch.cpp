...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (DELTA_CALIBRATION_MENU) && defined (ULTIPANEL) )
...
#endif
#if defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL_FEEDMULTIPLY) && defined (ULTIPANEL) )
// Dead zone at 100% feedrate
            if ((feedmultiply < 100 && (feedmultiply + int(encoderPosition)) > 100) ||
                    (feedmultiply > 100 && (feedmultiply + int(encoderPosition)) < 100)) {
                encoderPosition = 0;
...
// Audio feedback
            ...
            () {
#if defined (A) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
                _lcd_babystep(X_AXIS, PSTR(MSG_BABYSTEPPING_X));
#endif
#if defined (B) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
// buttons which take too long to read in interrupt context
                ...
                ((IS_SD_INSERTED != lcd_oldcardstatus && lcd_detected())) {
                    ...
                    lcd_implementation_init();
#endif
#if defined (B) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) )
...
//ULTIPANEL
            ...
            (const char* message) {
                ...
                lcdDrawUpdate = 2;
#endif
#if defined (B) && (defined (ULTRA_LCD) && defined (FILAMENT_LCD_DISPLAY) )
