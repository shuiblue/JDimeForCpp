...
#endif
#if defined (A) && (defined (DOGLCD) && defined (ULTRA_LCD) )
    #include "dogm_lcd_implementation.h"
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (DOGLCD) ) || defined (B) && defined (ULTRA_LCD)
...
#endif
#if defined (A) && (defined (DOGLCD) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
    #define ENCODER_STEPS_PER_MENU_ITEM 5
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_PULSES_PER_STEP) && defined (ULTIPANEL) )
    #define ENCODER_PULSES_PER_STEP 1
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (LCD_HAS_SLOW_BUTTONS) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
    //Contains the bits of the currently pressed buttons.
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && (SDCARDDETECT > -1) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (BABYSTEPPING) && defined (ULTRA_LCD) && defined (BABYSTEP_XY) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && (EMP_SENSOR_1 != 0 || TEMP_SENSOR_2 != 0 || TEMP_SENSOR_BED != 0 && )TEMP_SENSOR_0 != 0 && defined (ULTIPANEL) )
        MENU_ITEM(function, MSG_PREHEAT_ABS, lcd_preheat_abs0);
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) )
        MENU_ITEM(function, MSG_COOLDOWN, lcd_cooldown);
#endif
#if defined (A) && (defined (ULTRA_LCD) && PS_ON_PIN > -1 && defined (ULTIPANEL) )
        if (powersupply) {
...
//    MENU_ITEM_EDIT(int3, MSG_CONTRAST, &lcd_contrast, 0, 63);
    ...
    static void lcd_control_temperature_menu
    () {
#if defined (A) && (defined (ULTRA_LCD) && defined (PIDTEMP) && defined (ULTIPANEL) )
...
//PIDTEMP
    ...
    () {
        START_MENU();
        MENU_ITEM(back, MSG_CONTROL, lcd_control_menu);
#if defined (A) && (defined (ULTRA_LCD) && defined (ENABLE_AUTO_BED_LEVELING) && defined (ULTIPANEL) )
...
//ULTIPANEL
    ...
    () {
...
#endif
#if defined (B) && (defined (NEWPANEL) && defined (ULTRA_LCD) )
        ...
        WRITE(BTN_EN2,HIGH);
#endif
#if defined (A) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 )
        SET_INPUT(BTN_ENC);
#endif
#if defined (A) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 ) || defined (B) && (defined (NEWPANEL) && defined (ULTRA_LCD) )
        WRITE(BTN_ENC,HIGH);
#endif
#if defined (A) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) )
        ...
        WRITE(SHIFT_LD,HIGH);
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (NEWPANEL) )
// Not NEWPANEL
#endif
#if defined (A) && (defined (SR_LCD_2W_NL) && defined (ULTRA_LCD) && !defined (NEWPANEL) )
// Non latching 2 wire shift register
        pinMode (SR_DATA_PIN, OUTPUT);
        pinMode (SR_CLK_PIN, OUTPUT);
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined(SHIFT_CLK) && !defined (NEWPANEL) ) || defined (B) && (defined (ULTRA_LCD) && !defined (NEWPANEL) )
        pinMode(SHIFT_CLK,OUTPUT);
        pinMode(SHIFT_LD,OUTPUT);
...
#endif
//!NEWPANEL
#if defined (A) && ((defined (SDSUPPORT) && defined(SDCARDDETECT) && (SDCARDDETECT > 0) && )defined (ULTRA_LCD) )
        pinMode(SDCARDDETECT,INPUT);
#endif
#if defined (A) && ((defined (SDSUPPORT) && defined(SDCARDDETECT) && (SDCARDDETECT > 0) && )defined (ULTRA_LCD) ) || defined (B) && (defined (ULTRA_LCD) && (SDCARDDETECT > -1) )
...
//(SDCARDDETECT > -1)
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (LCD_HAS_SLOW_BUTTONS) )
        slow_buttons = 0;
#endif
        lcd_buttons_update();
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) ) || defined (B) && defined (ULTRA_LCD)
        encoderDiff = 0;
#endif
    }
    void lcd_update
...
#if defined (A) && (!defined (DOGLCD) && defined (ULTRA_LCD) ) || defined (B) && defined (ULTRA_LCD)
            (*currentMenu)();
#endif
#if defined (A) && (defined (LCD_HAS_STATUS_INDICATORS) && defined (ULTRA_LCD) )
...
//ULTIPANEL
    ...
    () {
        ...
        (READ(BTN_EN2)==0)
            newbutton|=EN_B;
#endif
#if defined (A) && (defined (NEWPANEL) && defined (ULTRA_LCD) && BTN_ENC > 0 && defined (ULTIPANEL) ) || defined (B) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        if
        ...
        buttons = newbutton;
#endif
#if defined (A) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (LCD_HAS_SLOW_BUTTONS) )
        buttons |= slow_buttons;
#endif
#if defined (A) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
