...
#endif
#if defined (B) && (defined(ULTIBOARD_V2_CONTROLLER) && defined (ULTRA_LCD) )
    #include "ultralcd_implementation_ultiboard_v2.h"
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (DOGLCD) ) || defined (B) && (!defined(ULTIBOARD_V2_CONTROLLER) && defined (ULTRA_LCD) )
...
#endif
#if defined (B) && (defined (ULTRA_LCD) && defined (REPRAPWORLD_KEYPAD) && defined (ULTIPANEL) )
...
#endif
#if defined (B) && (MOTOR_CURRENT_PWM_XY_PIN > -1 && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
//ULTIPANEL
    ...
    () {
        ...
        ((blocking_enc<millis()) && (READ(BTN_ENC)==0))
            newbutton |= EN_C;
#endif
#if defined (A) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        buttons = newbutton;
#endif
...
#endif
#if defined (B) && (defined (NEWPANEL) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
        buttons = newbutton;
#endif
