...
#if defined (A) && (SDCARDDETECT < 1 && defined (ULTRA_LCD) && defined (SDSUPPORT) && defined (ULTIPANEL) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && defined (ULTIPANEL) && defined (FILAMENTCHANGEENABLE) )
...
#if defined (A) && (defined (ULTRA_LCD) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined (ULTIPANEL) )
