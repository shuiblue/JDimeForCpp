...
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && defined (ULTIPANEL) )
    #define ENCODER_STEPS_PER_MENU_ITEM 5
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined(LCD_I2C_VIKI) && !defined (ENCODER_PULSES_PER_STEP) && defined (ULTIPANEL) )
    #define ENCODER_PULSES_PER_STEP 1
#endif
#if defined (A) && (defined (ULTRA_LCD) && !defined (ENCODER_STEPS_PER_MENU_ITEM) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) ) || defined (B) && (defined (ULTRA_LCD) && defined(LCD_I2C_VIKI) && defined (ULTIPANEL) )
...
#endif
#if defined (B) && (defined (DOGLCD) && defined (ULTRA_LCD) && defined (ULTIPANEL) )
...
//!NEWPANEL
        ...
        pinMode(SDCARDDETECT,INPUT);
#endif
#if defined (A) && ((defined (SDSUPPORT) && defined(SDCARDDETECT) && (SDCARDDETECT > 0) && )defined (ULTRA_LCD) ) || defined (B) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) )
...
//(SDCARDDETECT > 0)
    ...
    () {
        ...
        lcd_buttons_update();
#endif
#if defined (B) && (defined (ULTRA_LCD) && defined (LCD_HAS_SLOW_BUTTONS) )
...
#endif
#if defined (A) && (defined (ULTRA_LCD) && (SDCARDDETECT > 0) )
