...
#include "Marlin.h"
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (drsdre) && defined (SDSUPPORT)
...
#endif
#if defined (upstream) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (drsdre) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
