...
#include "Marlin.h"
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (gregor2005) && defined (SDSUPPORT)
...
#endif
#if defined (upstream) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (gregor2005) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
