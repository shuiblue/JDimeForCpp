...
#include "Marlin.h"
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (indi-3DR) && defined (SDSUPPORT)
...
#endif
#if defined (upstream) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (indi-3DR) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
