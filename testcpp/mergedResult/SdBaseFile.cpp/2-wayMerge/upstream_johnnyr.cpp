...
#endif
#if defined (upstream) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (johnnyr) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
