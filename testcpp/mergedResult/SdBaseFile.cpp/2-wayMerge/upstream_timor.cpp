#if defined (upstream) || defined (timor)
...
#include "Marlin.h"
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (timor) && defined (SDSUPPORT)
...
#endif
#if defined (upstream) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (timor) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
