...
#endif
#if defined (upstream) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (oliv3r) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
