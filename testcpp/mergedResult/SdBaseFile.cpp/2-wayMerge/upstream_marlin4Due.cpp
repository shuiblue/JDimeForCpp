...
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (marlin4Due) && (defined (SDSUPPORT) && defined (__AVR__) )
            PGM_P p = PSTR("|<>^+=?/[];,*\"\\");
            uint8_t b;
            while
            ((b = pgm_read_byte(p++)))
...
#endif
#if defined (upstream) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (marlin4Due) && ((ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
