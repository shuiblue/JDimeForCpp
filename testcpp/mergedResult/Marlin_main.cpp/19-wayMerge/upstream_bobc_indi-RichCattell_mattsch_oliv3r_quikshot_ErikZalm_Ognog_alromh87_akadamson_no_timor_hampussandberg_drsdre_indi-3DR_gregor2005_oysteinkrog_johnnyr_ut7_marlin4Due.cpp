...
/* -*- c++ -*- */
    ...
    */
    ...
    #include "Wire.h"
#endif
#if defined (upstream) && NUM_SERVOS > 0 || defined (bobc) && NUM_SERVOS > 0 || defined (indi-RichCattell) && NUM_SERVOS > 0 || defined (mattsch) && NUM_SERVOS > 0 || defined (oliv3r) && NUM_SERVOS > 0 || defined (quikshot) && NUM_SERVOS > 0 || defined (ErikZalm) && NUM_SERVOS > 0 || defined (Ognog) && NUM_SERVOS > 0 || defined (alromh87) && NUM_SERVOS > 0
    #include "Servo.h"
#endif
#if defined (marlin4Due) && HAS_SERVOS
    #include "servo.h"
#endif
#if defined (upstream) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (bobc) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (indi-RichCattell) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (mattsch) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (oliv3r) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (quikshot) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (ErikZalm) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (Ognog) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (alromh87) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (akadamson) && DIGIPOTSS_PIN > -1 || defined (hampussandberg) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (drsdre) && DIGIPOTSS_PIN > -1 || defined (indi-3DR) && DIGIPOTSS_PIN > -1 || defined (gregor2005) && DIGIPOTSS_PIN > -1 || defined (oysteinkrog) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (johnnyr) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (ut7) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (marlin4Due) && HAS_DIGIPOTSS
    #include <SPI.h>
#endif
#if defined (upstream)
    #define VERSION_STRING  "1.0.2"
#endif
#if defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (oliv3r) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (akadamson) || defined (hampussandberg) || defined (drsdre) || defined (indi-3DR) || defined (gregor2005) || defined (oysteinkrog) || defined (johnnyr) || defined (ut7)
    ...
    */
    ...
    // M402 - Raise z-probe if present
#endif
#if defined (upstream) || defined (mattsch) || defined (ErikZalm) || defined (oysteinkrog) || defined (ut7)
    // M404 - N<dia in mm> Enter the nominal filament width (3mm, 1.75mm ) or will display nominal filament width without parameters
    // M405 - Turn on Filament Sensor extrusion control.  Optional D<delay in cm> to set delay in centimeters between sensor and extruder
    // M406 - Turn off Filament Sensor extrusion control
...
#endif
#if defined (upstream) || defined (oysteinkrog) || defined (marlin4Due)
...
#endif
#if defined (upstream) && defined (SERVO_ENDSTOPS) || defined (bobc) && defined (SERVO_ENDSTOPS) || defined (indi-RichCattell) && defined (SERVO_ENDSTOPS) || defined (mattsch) && defined (SERVO_ENDSTOPS) || defined (oliv3r) && defined (SERVO_ENDSTOPS) || defined (quikshot) && defined (SERVO_ENDSTOPS) || defined (ErikZalm) && defined (SERVO_ENDSTOPS) || defined (Ognog) && defined (SERVO_ENDSTOPS) || defined (alromh87) && defined (SERVO_ENDSTOPS)
...
#endif
#if defined (upstream) && defined (BARICUDA) || defined (bobc) && defined (BARICUDA) || defined (indi-RichCattell) && defined (BARICUDA) || defined (mattsch) && defined (BARICUDA) || defined (oliv3r) && defined (BARICUDA) || defined (quikshot) && defined (BARICUDA) || defined (ErikZalm) && defined (BARICUDA) || defined (Ognog) && defined (BARICUDA) || defined (alromh87) && defined (BARICUDA)
    int ValvePressure=0;
    int EtoPPressure=0;
#endif
...
#endif
#if defined (bobc) && defined (FWRETRACT) || defined (indi-RichCattell) && defined (FWRETRACT) || defined (oliv3r) && defined (FWRETRACT) || defined (Ognog) && defined (FWRETRACT) || defined (alromh87) && defined (FWRETRACT) || defined (akadamson) && defined (FWRETRACT) || defined (drsdre) && defined (FWRETRACT) || defined (indi-3DR) && defined (FWRETRACT) || defined (gregor2005) && defined (FWRETRACT) || defined (johnnyr) && defined (FWRETRACT)
    bool retracted=false;
#endif
#if defined (upstream) && defined (FWRETRACT) || defined (mattsch) && defined (FWRETRACT) || defined (quikshot) && defined (FWRETRACT) || defined (ErikZalm) && defined (FWRETRACT) || defined (hampussandberg) && defined (FWRETRACT) || defined (oysteinkrog) && defined (FWRETRACT) || defined (ut7) && defined (FWRETRACT)
...
#endif
#if defined (upstream) && defined (FWRETRACT) || defined (mattsch) && defined (FWRETRACT) || defined (quikshot) && defined (FWRETRACT) || defined (ErikZalm) && defined (FWRETRACT) || defined (hampussandberg) && defined (FWRETRACT) || defined (oysteinkrog) && defined (FWRETRACT) || defined (ut7) && defined (FWRETRACT) || defined (marlin4Due) && ENABLED(FWRETRACT)
...
#endif
#if defined (upstream) && defined (SCARA) || defined (mattsch) && defined (SCARA) || defined (ErikZalm) && defined (SCARA) || defined (hampussandberg) && defined (SCARA) || defined (oysteinkrog) && defined (SCARA) || defined (ut7) && defined (SCARA)
    // Build size scaling
#endif
...
#endif
#if defined (upstream) && defined (SCARA) || defined (mattsch) && defined (SCARA) || defined (ErikZalm) && defined (SCARA) || defined (hampussandberg) && defined (SCARA) || defined (oysteinkrog) && defined (SCARA) || defined (ut7) && defined (SCARA) || defined (marlin4Due) && ENABLED(SCARA)
...
// Build size scaling, default to 1
    ...
    bool cancel_heatup = false ;
#endif
#if defined (upstream) && defined (FILAMENT_SENSOR) || defined (mattsch) && defined (FILAMENT_SENSOR) || defined (ErikZalm) && defined (FILAMENT_SENSOR) || defined (oysteinkrog) && defined (FILAMENT_SENSOR) || defined (ut7) && defined (FILAMENT_SENSOR) || defined (marlin4Due) && ENABLED(FILAMENT_SENSOR)
...
#endif
#if defined (upstream) || defined (ErikZalm) || defined (oysteinkrog)
    const char errormagic[] PROGMEM = "Error:";
#endif
...
#endif
#if defined (upstream) && !defined (DELTA) || defined (mattsch) && !defined (DELTA) || defined (oliv3r) && defined (DELTA) || defined (ErikZalm) && !defined (DELTA) || defined (hampussandberg) || defined (indi-3DR) || defined (oysteinkrog) && !defined (DELTA) || defined (ut7) && !defined (DELTA)
...
#endif
#if defined (upstream) || defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (oliv3r) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (akadamson) || defined (hampussandberg) || defined (drsdre) || defined (indi-3DR) || defined (gregor2005) || defined (oysteinkrog) || defined (johnnyr) || defined (ut7) || defined (marlin4Due) && ENABLED(SDSUPPORT)
...
(const char *s_P, unsigned long v) {
    ...
    // HAL for Due
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (mattsch) && defined (SDSUPPORT) || defined (ErikZalm) && defined (SDSUPPORT) || defined (oysteinkrog) && defined (SDSUPPORT) || defined (marlin4Due) && (defined (SDSUPPORT) && defined (__AVR__) )
#include "SdFatUtil.h"
...
#endif
#if defined (upstream) && !defined (SDSUPPORT) || defined (indi-RichCattell) || defined (mattsch) && !defined (SDSUPPORT) || defined (oliv3r) || defined (quikshot) || defined (ErikZalm) && !defined (SDSUPPORT) || defined (Ognog) || defined (alromh87) || defined (akadamson) || defined (hampussandberg) || defined (drsdre) || defined (indi-3DR) || defined (gregor2005) || defined (oysteinkrog) && !defined (SDSUPPORT) || defined (johnnyr) || defined (ut7) || defined (marlin4Due) && (!defined (SDSUPPORT) && defined (__AVR__) )
...
#endif
#if defined (upstream) || defined (mattsch) || defined (ErikZalm) || defined (oysteinkrog) || defined (marlin4Due) && defined (__AVR__)
    //!SDSUPPORT
#endif
#if defined (oliv3r)
...
void setup_killpin
() {
#if defined (bobc) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (indi-RichCattell) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (mattsch) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (quikshot) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (Ognog) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (alromh87) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (akadamson) &&  KILL_PIN>-1 ) || defined (hampussandberg) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (drsdre) &&  KILL_PIN>-1 ) || defined (indi-3DR) &&  KILL_PIN>-1 ) || defined (gregor2005) &&  KILL_PIN>-1 ) || defined (johnnyr) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (ut7) && (defined(KILL_PIN) && KILL_PIN > -1)
    pinMode(KILL_PIN,INPUT);
#endif
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (oliv3r) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (ErikZalm) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (oysteinkrog) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (marlin4Due) && HAS_KILL
    SET_INPUT(KILL_PIN);
#endif
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (bobc) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (indi-RichCattell) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (mattsch) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (oliv3r) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (quikshot) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (ErikZalm) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (Ognog) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (alromh87) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (akadamson) &&  KILL_PIN>-1 ) || defined (hampussandberg) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (drsdre) &&  KILL_PIN>-1 ) || defined (indi-3DR) &&  KILL_PIN>-1 ) || defined (gregor2005) &&  KILL_PIN>-1 ) || defined (oysteinkrog) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (johnnyr) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (ut7) && (defined(KILL_PIN) && KILL_PIN > -1)
    WRITE(KILL_PIN,HIGH);
#endif
...
#endif
#if defined (upstream) || defined (ErikZalm) || defined (oysteinkrog) || defined (marlin4Due)
// Set home pin
...
void setup_photpin
() {
#if defined (upstream) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (bobc) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (indi-RichCattell) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (mattsch) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (oliv3r) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (quikshot) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (ErikZalm) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (Ognog) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (alromh87) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (akadamson) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) ) || defined (hampussandberg) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (drsdre) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) ) || defined (indi-3DR) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) ) || defined (gregor2005) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) ) || defined (oysteinkrog) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (johnnyr) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (ut7) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1)
...
() {
#if defined (upstream) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (bobc) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (indi-RichCattell) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (mattsch) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (oliv3r) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (quikshot) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (ErikZalm) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (Ognog) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (alromh87) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (akadamson) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) ) || defined (hampussandberg) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (drsdre) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) ) || defined (indi-3DR) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) ) || defined (gregor2005) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) ) || defined (oysteinkrog) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (johnnyr) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (ut7) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1)
...
#endif
#if defined (upstream) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (bobc) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (indi-RichCattell) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (mattsch) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (oliv3r) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (quikshot) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (ErikZalm) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (Ognog) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (alromh87) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (hampussandberg) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (drsdre) && (PS_ON_PIN > -1) || defined (gregor2005) && (PS_ON_PIN > -1) || defined (oysteinkrog) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (johnnyr) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (ut7) && (defined(PS_ON_PIN) && PS_ON_PIN > -1)
...
#endif
#if defined (upstream) || defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (oliv3r) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (oysteinkrog) || defined (johnnyr) || defined (ut7) || defined (marlin4Due)
...
#endif
#if defined (upstream) || defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (oliv3r) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (gregor2005) || defined (oysteinkrog) || defined (johnnyr) || defined (ut7) || defined (marlin4Due)
...
// Initialize stepper, this enables interrupts!
    ...
    servo_init();
#endif
#if defined (upstream) || defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (oliv3r) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (drsdre) || defined (indi-3DR) || defined (gregor2005) || defined (oysteinkrog) || defined (johnnyr) || defined (ut7)
    lcd_init();
#endif
#if defined (marlin4Due)
    init_fsr_values();
#endif
#if defined (upstream) || defined (bobc) || defined (indi-RichCattell) || defined (mattsch) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (oysteinkrog) || defined (johnnyr) || defined (ut7)
    _delay_ms(1000);
// wait 1sec to display the splash screen
#endif
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (bobc) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (indi-RichCattell) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (mattsch) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (oliv3r) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (quikshot) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (ErikZalm) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (Ognog) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (alromh87) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (hampussandberg) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (gregor2005) && defined (CONTROLLERFAN_PIN) || defined (oysteinkrog) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (johnnyr) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (ut7) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (marlin4Due) && HAS_CONTROLLERFAN
...
#endif
#if defined (upstream) && defined (DIGIPOT_I2C) || defined (bobc) && defined (DIGIPOT_I2C) || defined (mattsch) && defined (DIGIPOT_I2C) || defined (quikshot) && defined (DIGIPOT_I2C) || defined (ErikZalm) && defined (DIGIPOT_I2C) || defined (Ognog) && defined (DIGIPOT_I2C) || defined (alromh87) && defined (DIGIPOT_I2C) || defined (hampussandberg) && defined (DIGIPOT_I2C) || defined (oysteinkrog) && defined (DIGIPOT_I2C) || defined (johnnyr) && defined (DIGIPOT_I2C) || defined (ut7) && defined (DIGIPOT_I2C) || defined (marlin4Due) && ENABLED(DIGIPOT_I2C)
    digipot_i2c_init();
#endif
#if defined (gregor2005) && defined (EXTRUDERFAN_PIN)
//Set pin used for extruder cooling fan
#endif
#if defined (upstream) && defined (Z_PROBE_SLED) || defined (mattsch) && defined (Z_PROBE_SLED) || defined (ErikZalm) && defined (Z_PROBE_SLED) || defined (hampussandberg) && defined (Z_PROBE_SLED) || defined (oysteinkrog) && defined (Z_PROBE_SLED) || defined (ut7) && defined (Z_PROBE_SLED)
...
#endif
#if defined (upstream) && defined (Z_PROBE_SLED) || defined (mattsch) && defined (Z_PROBE_SLED) || defined (ErikZalm) && defined (Z_PROBE_SLED) || defined (hampussandberg) && defined (Z_PROBE_SLED) || defined (oysteinkrog) && defined (Z_PROBE_SLED) || defined (ut7) && defined (Z_PROBE_SLED) || defined (marlin4Due) && ENABLED(Z_PROBE_SLED)
// turn it off
#endif
#if defined (upstream) || defined (mattsch) || defined (ErikZalm) || defined (hampussandberg) || defined (oysteinkrog) || defined (ut7) || defined (marlin4Due)
// Z_PROBE_SLED
#endif
#if defined (upstream) || defined (ErikZalm) || defined (oysteinkrog) || defined (marlin4Due)
    setup_homepin();
...
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (bobc) && defined (SDSUPPORT) || defined (indi-RichCattell) && defined (SDSUPPORT) || defined (mattsch) && defined (SDSUPPORT) || defined (oliv3r) && defined (SDSUPPORT) || defined (quikshot) && defined (SDSUPPORT) || defined (ErikZalm) && defined (SDSUPPORT) || defined (Ognog) && defined (SDSUPPORT) || defined (alromh87) && defined (SDSUPPORT) || defined (akadamson) && defined (SDSUPPORT) || defined (hampussandberg) && defined (SDSUPPORT) || defined (drsdre) && defined (SDSUPPORT) || defined (indi-3DR) && defined (SDSUPPORT) || defined (gregor2005) && defined (SDSUPPORT) || defined (oysteinkrog) && defined (SDSUPPORT) || defined (johnnyr) && defined (SDSUPPORT) || defined (ut7) && defined (SDSUPPORT)
...
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (bobc) && defined (SDSUPPORT) || defined (mattsch) && defined (SDSUPPORT) || defined (quikshot) && defined (SDSUPPORT) || defined (ErikZalm) && defined (SDSUPPORT) || defined (Ognog) && defined (SDSUPPORT) || defined (alromh87) && defined (SDSUPPORT) || defined (hampussandberg) && defined (SDSUPPORT) || defined (oysteinkrog) && defined (SDSUPPORT) || defined (johnnyr) && defined (SDSUPPORT) || defined (ut7) && defined (SDSUPPORT)
...
#endif
#if defined (upstream) && defined (DUAL_X_CARRIAGE) || defined (bobc) && defined (DUAL_X_CARRIAGE) || defined (indi-RichCattell) && defined (DUAL_X_CARRIAGE) || defined (mattsch) && defined (DUAL_X_CARRIAGE) || defined (quikshot) && defined (DUAL_X_CARRIAGE) || defined (ErikZalm) && defined (DUAL_X_CARRIAGE) || defined (Ognog) && defined (DUAL_X_CARRIAGE) || defined (alromh87) && defined (DUAL_X_CARRIAGE) || defined (hampussandberg) && defined (DUAL_X_CARRIAGE) || defined (oysteinkrog) && defined (DUAL_X_CARRIAGE) || defined (johnnyr) && defined (DUAL_X_CARRIAGE) || defined (ut7) && defined (DUAL_X_CARRIAGE) || defined (marlin4Due) && ENABLED(DUAL_X_CARRIAGE)
...
#endif
#if defined (upstream) || defined (bobc) || defined (mattsch) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (oysteinkrog) || defined (johnnyr) || defined (ut7)
