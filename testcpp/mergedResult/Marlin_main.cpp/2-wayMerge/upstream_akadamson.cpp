...
#include "Marlin.h"
    ...
    #include "Servo.h"
#endif
#if defined (upstream) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (akadamson) && DIGIPOTSS_PIN > -1
    #include <SPI.h>
#endif
#if defined (upstream)
...
#endif
#if defined (upstream) && !defined (SDSUPPORT) || defined (akadamson)
extern "C"
{
...
#endif
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (akadamson) &&  KILL_PIN>-1 )
    WRITE(KILL_PIN,HIGH);
#endif
}
#endif
...
void setup_photpin
() {
#if defined (upstream) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (akadamson) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) )
...
() {
#if defined (upstream) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (akadamson) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) )
...
#if defined (upstream) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (akadamson) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) )
    SERIAL_ECHO_START;
...
void get_arc_coordinates
() {
#if defined (upstream) && defined (SF_ARC_FIX) || defined (akadamson) && defined (SF_ARC_FIX)
...
//DUAL_X_CARRIAGE
#endif
#if defined (upstream) && (! (defined DELTA || defined SCARA)) || defined (akadamson)
...
#endif
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (akadamson) && defined (CONTROLLERFAN_PIN)
...
#endif
#if defined (upstream) && defined (EXTRUDER_RUNOUT_PREVENT) || defined (akadamson) && defined (EXTRUDER_RUNOUT_PREVENT)
    if
...
;
#if defined (upstream) && defined (FAST_PWM_FAN) || defined (akadamson) && defined (FAST_PWM_FAN)
...
#endif
#endif
#if defined (akadamson) && defined (FAST_PWM_FAN)
#if defined(TCCR0A)
    case TIMER0A:
    case TIMER0B:
