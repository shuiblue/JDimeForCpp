...
/* -*- c++ -*- */
    ...
    */
    ...
    #include "Marlin.h"
#endif
#if defined (upstream) && defined (ENABLE_AUTO_BED_LEVELING) || defined (marlin4Due) && ENABLED(ENABLE_AUTO_BED_LEVELING)
    #include "vector_3.h"
#endif
#if defined (upstream) && (defined (ENABLE_AUTO_BED_LEVELING) && defined (AUTO_BED_LEVELING_GRID) ) || defined (marlin4Due) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(AUTO_BED_LEVELING_GRID) )
    #include "qr_solve.h"
#endif
#if defined (upstream) || defined (marlin4Due)
    ...
    #include "blinkm.h"
#endif
#if defined (upstream) && defined (BLINKM) || defined (marlin4Due) && ENABLED(BLINKM)
    #include "Wire.h"
#endif
    ...
    */
    ...
    //===========================================================================
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (marlin4Due) && ENABLED(SDSUPPORT)
    CardReader card;
#endif
#if defined (upstream)
...
#endif
#if defined (upstream) && defined (BARICUDA) || defined (marlin4Due) && ENABLED(BARICUDA)
    int ValvePressure=0;
    int EtoPPressure=0;
#endif
#if defined (upstream) && defined (FWRETRACT) || defined (marlin4Due) && ENABLED(FWRETRACT)
...
float delta[3] = { 0 };
#endif
#if defined (upstream) && defined (DELTA) || defined (marlin4Due) && ENABLED(DELTA)
...
#endif
#if defined (upstream) && defined (SCARA) || defined (marlin4Due) && ENABLED(SCARA)
...
// Build size scaling, default to 1
    ...
    bool cancel_heatup = false ;
#endif
#if defined (upstream) && defined (FILAMENT_SENSOR) || defined (marlin4Due) && ENABLED(FILAMENT_SENSOR)
...
#endif
#if defined (upstream) || defined (marlin4Due) && ENABLED(SDSUPPORT)
...
#endif
#if defined (upstream) && defined (CHDK) || defined (marlin4Due) && defined (CHDK)
...
#endif
#if defined (upstream) || defined (marlin4Due) && defined (__AVR__)
    //!SDSUPPORT
#endif
#if defined (upstream)
...
void setup_killpin
() {
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (marlin4Due) && HAS_KILL
    SET_INPUT(KILL_PIN);
#endif
...
void setup_homepin
(void) {
#if defined (upstream) && (defined(HOME_PIN) && HOME_PIN > -1) || defined (marlin4Due) && HAS_HOME
    SET_INPUT(HOME_PIN);
#endif
...
#endif
#if defined (upstream) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (marlin4Due) && (defined (STRING_DISTRIBUTION_DATE) && defined (STRING_CONFIG_H_AUTHOR) )
    SERIAL_ECHO_START;
...
// wait 1sec to display the splash screen
#endif
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (marlin4Due) && HAS_CONTROLLERFAN
...
#endif
#if defined (upstream) && defined (DIGIPOT_I2C) || defined (marlin4Due) && ENABLED(DIGIPOT_I2C)
    digipot_i2c_init();
#endif
...
#endif
#if defined (upstream) && defined (Z_PROBE_SLED) || defined (marlin4Due) && ENABLED(Z_PROBE_SLED)
// turn it off
#endif
// Z_PROBE_SLED
    setup_homepin();
...
#endif
#if defined (upstream) && defined (DUAL_X_CARRIAGE) || defined (marlin4Due) && ENABLED(DUAL_X_CARRIAGE)
...
#endif
#if defined (upstream) && (defined (ENABLE_AUTO_BED_LEVELING) && defined (AUTO_BED_LEVELING_GRID) ) || defined (marlin4Due) && (DISABLED(DELTA) && ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(AUTO_BED_LEVELING_GRID) )
...
#endif
#if defined (upstream) && (!defined (AUTO_BED_LEVELING_GRID) && defined (ENABLE_AUTO_BED_LEVELING) ) || defined (marlin4Due) && (!ENABLED(AUTO_BED_LEVELING_GRID) && ENABLED(ENABLE_AUTO_BED_LEVELING) )
...
// !DELTA
#endif
#if defined (upstream) && defined (ENABLE_AUTO_BED_LEVELING) || defined (marlin4Due) && (!ENABLED(DELTA) && ENABLED(ENABLE_AUTO_BED_LEVELING) )
    plan_bed_level_matrix.set_to_identity();
...
() {
#if defined (upstream) && (defined (ENDSTOPS_ONLY_FOR_HOMING) && defined (ENABLE_AUTO_BED_LEVELING) ) || defined (marlin4Due) && (ENABLED(ENABLE_AUTO_BED_LEVELING) && ENABLED(ENDSTOPS_ONLY_FOR_HOMING) )
