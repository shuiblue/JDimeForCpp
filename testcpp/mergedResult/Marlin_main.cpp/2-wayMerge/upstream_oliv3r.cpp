...
#include "Marlin.h"
    ...
    #include "Wire.h"
#endif
#if defined (upstream) && NUM_SERVOS > 0 || defined (oliv3r) && NUM_SERVOS > 0
    #include "Servo.h"
#endif
#if defined (upstream) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (oliv3r) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1)
    #include <SPI.h>
#endif
#if defined (upstream)
    ...
    //===========================================================================
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (oliv3r) && defined (SDSUPPORT)
    CardReader card;
#endif
#if defined (upstream) || defined (oliv3r)
...
#endif
#if defined (upstream) && defined (SERVO_ENDSTOPS) || defined (oliv3r) && defined (SERVO_ENDSTOPS)
    int servo_endstops[] = SERVO_ENDSTOPS;
    int servo_endstop_angles[] = SERVO_ENDSTOP_ANGLES;
#endif
#if defined (upstream) && defined (BARICUDA) || defined (oliv3r) && defined (BARICUDA)
    int ValvePressure=0;
    int EtoPPressure=0;
#endif
#if defined (upstream) && defined (FWRETRACT) || defined (oliv3r) && defined (FWRETRACT)
...
#endif
#if defined (upstream) && !defined (DELTA) || defined (oliv3r) && defined (DELTA)
...
#endif
#if defined (upstream) && !defined (SDSUPPORT) || defined (oliv3r)
extern "C"
{
...
void setup_killpin
() {
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (oliv3r) && (defined(KILL_PIN) && KILL_PIN > -1)
    SET_INPUT(KILL_PIN);
    WRITE(KILL_PIN,HIGH);
#endif
}
...
void setup_photpin
() {
#if defined (upstream) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (oliv3r) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1)
...
() {
#if defined (upstream) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (oliv3r) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1)
    SET_OUTPUT(SUICIDE_PIN);
    WRITE(SUICIDE_PIN, HIGH);
#endif
#if defined (upstream) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (oliv3r) && (defined(PS_ON_PIN) && PS_ON_PIN > -1)
    SET_OUTPUT(PS_ON_PIN);
#endif
#if defined (upstream) && (defined(PS_DEFAULT_OFF) && (defined(PS_ON_PIN) && PS_ON_PIN > -1 &)
    WRITE(PS_ON_PIN, PS_ON_ASLEEP);
#endif
#if defined (upstream) && ((defined(PS_ON_PIN) && PS_ON_PIN > -1 && )!defined(PS_DEFAULT_OFF) ) || defined (oliv3r) && (defined(PS_ON_PIN) && PS_ON_PIN > -1)
...
void servo_init
() {
#if defined (upstream) && ((NUM_SERVOS >= 1) && defined(SERVO0_PIN) && (SERVO0_PIN > -1)) || defined (oliv3r) && ((NUM_SERVOS >= 1) && defined(SERVO0_PIN) && (SERVO0_PIN > -1))
    servos[0].attach(SERVO0_PIN);
#endif
#if defined (upstream) && ((NUM_SERVOS >= 2) && defined(SERVO1_PIN) && (SERVO1_PIN > -1)) || defined (oliv3r) && ((NUM_SERVOS >= 2) && defined(SERVO1_PIN) && (SERVO1_PIN > -1))
    servos[1].attach(SERVO1_PIN);
#endif
#if defined (upstream) && ((NUM_SERVOS >= 3) && defined(SERVO2_PIN) && (SERVO2_PIN > -1)) || defined (oliv3r) && ((NUM_SERVOS >= 3) && defined(SERVO2_PIN) && (SERVO2_PIN > -1))
    servos[2].attach(SERVO2_PIN);
#endif
#if defined (upstream) && ((NUM_SERVOS >= 4) && defined(SERVO3_PIN) && (SERVO3_PIN > -1)) || defined (oliv3r) && ((NUM_SERVOS >= 4) && defined(SERVO3_PIN) && (SERVO3_PIN > -1))
    servos[3].attach(SERVO3_PIN);
#endif
#if defined (upstream) && (NUM_SERVOS >= 5) || defined (oliv3r) && (NUM_SERVOS >= 5)
...
#if defined (upstream) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (oliv3r) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) )
    SERIAL_ECHO_START;
...
#endif
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (oliv3r) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1)
...
#if defined (upstream) && EXTRUDERS > 1 || defined (oliv3r) && EXTRUDERS > 1
        if
        (tmp_extruder != active_extruder) {
...
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) ) || defined (oliv3r) && EXTRUDERS > 1
...
//sent position to plan_set_position();
            plan_set_position(delta[X_AXIS], delta[Y_AXIS], delta[Z_AXIS],current_position[E_AXIS]);
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DELTA) ) || defined (oliv3r) && EXTRUDERS > 1
            plan_set_position(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS]);
#endif
...
void get_arc_coordinates
() {
#if defined (upstream) && defined (SF_ARC_FIX) || defined (oliv3r) && defined (SF_ARC_FIX)
...
//DUAL_X_CARRIAGE
#endif
#if defined (upstream) && (! (defined DELTA || defined SCARA)) || defined (oliv3r) && !defined (DELTA)
...
#if defined (upstream) && (defined(FAN_PIN) && CONTROLLERFAN_PIN == FAN_PIN && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1 &) || defined (oliv3r) && (defined(FAN_PIN) && CONTROLLERFAN_PIN == FAN_PIN && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1 &)
...
// -------------------------------------------------------------------------------
    ...
    ( 0 == READ(KILL_PIN) ) {
        ...
        killCount++;
#endif
#if defined (oliv3r) && (defined(KILL_PIN) && KILL_PIN > -1)kill();
#endif
    }
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1)
    else if (killCount > 0) {
...
#endif
#if defined (upstream) && defined (EXTRUDER_RUNOUT_PREVENT) || defined (oliv3r) && defined (EXTRUDER_RUNOUT_PREVENT)
    if
...
#endif
#if defined (oliv3r) && defined (EXTRUDER_RUNOUT_PREVENT)
            plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS],
...
#endif
;
#if defined (upstream) && defined (FAST_PWM_FAN) || defined (oliv3r) && defined (FAST_PWM_FAN)
