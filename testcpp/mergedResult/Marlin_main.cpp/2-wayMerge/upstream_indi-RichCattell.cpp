...
#include "Marlin.h"
    ...
    #include "Wire.h"
#endif
#if defined (upstream) && NUM_SERVOS > 0 || defined (indi-RichCattell) && NUM_SERVOS > 0
    #include "Servo.h"
#endif
#if defined (upstream) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (indi-RichCattell) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1)
    #include <SPI.h>
#endif
#if defined (upstream)
    ...
    //===========================================================================
#endif
#if defined (upstream) && defined (SDSUPPORT) || defined (indi-RichCattell) && defined (SDSUPPORT)
    CardReader card;
#endif
#if defined (upstream) || defined (indi-RichCattell)
...
#endif
#if defined (upstream) && defined (DELTA) || defined (indi-RichCattell) && defined (DELTA)
...
float zprobe_zoffset;
    ...
    // Extruder offset
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) ) || defined (indi-RichCattell) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) )
...
#endif
#if defined (upstream) && EXTRUDERS > 1 || defined (indi-RichCattell) && EXTRUDERS > 1
float extruder_offset[NUM_EXTRUDER_OFFSETS][EXTRUDERS] = {
    ...
    int fanSpeed=0;
#endif
#if defined (upstream) && defined (SERVO_ENDSTOPS) || defined (indi-RichCattell) && defined (SERVO_ENDSTOPS)
    int servo_endstops[] = SERVO_ENDSTOPS;
    int servo_endstop_angles[] = SERVO_ENDSTOP_ANGLES;
#endif
#if defined (upstream) && defined (BARICUDA) || defined (indi-RichCattell) && defined (BARICUDA)
    int ValvePressure=0;
    int EtoPPressure=0;
#endif
...
#endif
#if defined (upstream) && (!defined (PS_DEFAULT_OFF) && defined (ULTIPANEL) ) || defined (indi-RichCattell) && defined (ULTIPANEL)
...
#endif
#if defined (upstream) && !defined (SDSUPPORT) || defined (indi-RichCattell)
extern "C"
{
...
#endif
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (indi-RichCattell) && (defined(KILL_PIN) && KILL_PIN > -1)
    WRITE(KILL_PIN,HIGH);
#endif
}
#endif
...
void setup_photpin
() {
#if defined (upstream) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (indi-RichCattell) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1)
...
() {
#if defined (upstream) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (indi-RichCattell) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1)
    SET_OUTPUT(SUICIDE_PIN);
    WRITE(SUICIDE_PIN, HIGH);
#endif
#if defined (upstream) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (indi-RichCattell) && (defined(PS_ON_PIN) && PS_ON_PIN > -1)
    SET_OUTPUT(PS_ON_PIN);
#endif
#if defined (upstream) && (defined(PS_DEFAULT_OFF) && (defined(PS_ON_PIN) && PS_ON_PIN > -1 &)
    WRITE(PS_ON_PIN, PS_ON_ASLEEP);
#endif
#if defined (upstream) && ((defined(PS_ON_PIN) && PS_ON_PIN > -1 && )!defined(PS_DEFAULT_OFF) ) || defined (indi-RichCattell) && (defined(PS_ON_PIN) && PS_ON_PIN > -1)
...
void servo_init
() {
#if defined (upstream) && ((NUM_SERVOS >= 1) && defined(SERVO0_PIN) && (SERVO0_PIN > -1)) || defined (indi-RichCattell) && ((NUM_SERVOS >= 1) && defined(SERVO0_PIN) && (SERVO0_PIN > -1))
    servos[0].attach(SERVO0_PIN);
#endif
#if defined (upstream) && ((NUM_SERVOS >= 2) && defined(SERVO1_PIN) && (SERVO1_PIN > -1)) || defined (indi-RichCattell) && ((NUM_SERVOS >= 2) && defined(SERVO1_PIN) && (SERVO1_PIN > -1))
    servos[1].attach(SERVO1_PIN);
#endif
#if defined (upstream) && ((NUM_SERVOS >= 3) && defined(SERVO2_PIN) && (SERVO2_PIN > -1)) || defined (indi-RichCattell) && ((NUM_SERVOS >= 3) && defined(SERVO2_PIN) && (SERVO2_PIN > -1))
    servos[2].attach(SERVO2_PIN);
#endif
#if defined (upstream) && ((NUM_SERVOS >= 4) && defined(SERVO3_PIN) && (SERVO3_PIN > -1)) || defined (indi-RichCattell) && ((NUM_SERVOS >= 4) && defined(SERVO3_PIN) && (SERVO3_PIN > -1))
    servos[3].attach(SERVO3_PIN);
#endif
#if defined (upstream) && (NUM_SERVOS >= 5) || defined (indi-RichCattell) && (NUM_SERVOS >= 5)
...
#if defined (upstream) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (indi-RichCattell) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) )
    SERIAL_ECHO_START;
...
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (indi-RichCattell) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1)
...
#endif
#if defined (upstream) && (defined (DUAL_X_CARRIAGE) && (X_HOME_DIR != -1 || X2_HOME_DIR != 1 &) || defined (indi-RichCattell) && (defined (DUAL_X_CARRIAGE) && (X_HOME_DIR != -1 || X2_HOME_DIR != 1 &)
    #error "Please use canonical x-carriage assignment"
    // the x-carriages are defined by their homing directions
#endif
#if defined (upstream) && defined (DUAL_X_CARRIAGE) || defined (indi-RichCattell) && defined (DUAL_X_CARRIAGE)
...
//sent position to plan_set_position();
                plan_set_position(delta[X_AXIS], delta[Y_AXIS], delta[Z_AXIS],current_position[E_AXIS]);
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DELTA) ) || defined (indi-RichCattell) && EXTRUDERS > 1
                plan_set_position(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS]);
#endif
...
void get_arc_coordinates
() {
#if defined (upstream) && defined (SF_ARC_FIX) || defined (indi-RichCattell) && defined (SF_ARC_FIX)
...
// DELTA
#endif
#if defined (upstream) && defined (DUAL_X_CARRIAGE) || defined (indi-RichCattell) && (defined (DUAL_X_CARRIAGE) && !defined (DELTA) )
    if
...
#endif
#if defined (upstream) || defined (indi-RichCattell) && !defined (DELTA)
//DUAL_X_CARRIAGE
#endif
#if defined (upstream) && (! (defined DELTA || defined SCARA)) || defined (indi-RichCattell) && !defined (DELTA)
...
#if defined (upstream) && (defined(FAN_PIN) && CONTROLLERFAN_PIN == FAN_PIN && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1 &) || defined (indi-RichCattell) && (defined(FAN_PIN) && CONTROLLERFAN_PIN == FAN_PIN && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1 &)
...
#endif
#if defined (upstream) && defined (EXTRUDER_RUNOUT_PREVENT) || defined (indi-RichCattell) && defined (EXTRUDER_RUNOUT_PREVENT)
    if
...
;
#if defined (upstream) && defined (FAST_PWM_FAN) || defined (indi-RichCattell) && defined (FAST_PWM_FAN)
