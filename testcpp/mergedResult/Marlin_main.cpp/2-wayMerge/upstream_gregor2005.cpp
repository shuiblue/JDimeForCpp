...
#include "Marlin.h"
    ...
    #include "Servo.h"
#endif
#if defined (upstream) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (gregor2005) && DIGIPOTSS_PIN > -1
    #include <SPI.h>
#endif
#if defined (upstream)
...
#endif
#if defined (gregor2005) && EXTRUDERS > 1
...
#endif
#if defined (gregor2005) && defined (FWRETRACT)
...
#endif
#if defined (upstream) && !defined (SDSUPPORT) || defined (gregor2005)
extern "C"
{
...
() {
    ...
    SET_INPUT(KILL_PIN);
#endif
#if defined (gregor2005) &&  KILL_PIN>-1 )
    pinMode(KILL_PIN,INPUT);
#endif
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (gregor2005) &&  KILL_PIN>-1 )
    WRITE(KILL_PIN,HIGH);
#endif
}
#endif
...
void setup_photpin
() {
#if defined (upstream) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (gregor2005) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) )
...
() {
#if defined (upstream) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (gregor2005) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) )
    SET_OUTPUT(SUICIDE_PIN);
    WRITE(SUICIDE_PIN, HIGH);
#endif
#if defined (upstream) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (gregor2005) && (PS_ON_PIN > -1)
    SET_OUTPUT(PS_ON_PIN);
#endif
#if defined (upstream) && (defined(PS_DEFAULT_OFF) && (defined(PS_ON_PIN) && PS_ON_PIN > -1 &)
    WRITE(PS_ON_PIN, PS_ON_ASLEEP);
#endif
#if defined (upstream) && ((defined(PS_ON_PIN) && PS_ON_PIN > -1 && )!defined(PS_DEFAULT_OFF) ) || defined (gregor2005) && (PS_ON_PIN > -1)
...
#if defined (upstream) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (gregor2005) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) )
    SERIAL_ECHO_START;
...
#endif
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (gregor2005) && defined (CONTROLLERFAN_PIN)
...
#endif
#if defined (gregor2005) && defined (SDSUPPORT)
...
#if defined (upstream) && EXTRUDERS > 1 || defined (gregor2005) && EXTRUDERS > 1
            if
            (tmp_extruder != active_extruder) {
...
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) ) || defined (gregor2005) && EXTRUDERS > 1
...
//sent position to plan_set_position();
                plan_set_position(delta[X_AXIS], delta[Y_AXIS], delta[Z_AXIS],current_position[E_AXIS]);
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DELTA) ) || defined (gregor2005) && EXTRUDERS > 1
                plan_set_position(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS]);
#endif
...
void get_arc_coordinates
() {
#if defined (upstream) && defined (SF_ARC_FIX) || defined (gregor2005) && defined (SF_ARC_FIX)
...
//DUAL_X_CARRIAGE
#endif
#if defined (upstream) && (! (defined DELTA || defined SCARA)) || defined (gregor2005)
...
//Not a time critical function, so we only check every 2500ms
    ...
    (!READ(X_ENABLE_PIN) || !READ(Y_ENABLE_PIN) || !READ(Z_ENABLE_PIN) || (soft_pwm_bed > 0)
            ...
            || !READ(E0_ENABLE_PIN))
#endif
#if defined (gregor2005) && defined (CONTROLLERFAN_PIN)
...
// -------------------------------------------------------------------------------
    ...
    ( 0 == READ(KILL_PIN) ) {
        ...
        killCount++;
#endif
#if defined (gregor2005) &&  KILL_PIN>-1 )kill();
#endif
    }
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1)
    else if (killCount > 0) {
...
#endif
#if defined (upstream) && defined (EXTRUDER_RUNOUT_PREVENT) || defined (gregor2005) && defined (EXTRUDER_RUNOUT_PREVENT)
    if
...
#endif
#if defined (gregor2005) && defined (EXTRUDER_RUNOUT_PREVENT)
            plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS],
...
;
#if defined (upstream) && defined (FAST_PWM_FAN) || defined (gregor2005) && defined (FAST_PWM_FAN)
