...
#include "Marlin.h"
    ...
    #include "Servo.h"
#endif
#if defined (upstream) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (drsdre) && DIGIPOTSS_PIN > -1
    #include <SPI.h>
#endif
#if defined (upstream)
...
#endif
#if defined (upstream) && !defined (SDSUPPORT) || defined (drsdre)
extern "C"
{
...
#endif
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (drsdre) &&  KILL_PIN>-1 )
    WRITE(KILL_PIN,HIGH);
#endif
}
#endif
...
void setup_photpin
() {
#if defined (upstream) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (drsdre) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) )
...
() {
#if defined (upstream) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (drsdre) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) )
    SET_OUTPUT(SUICIDE_PIN);
    WRITE(SUICIDE_PIN, HIGH);
#endif
#if defined (upstream) && (defined(PS_ON_PIN) && PS_ON_PIN > -1) || defined (drsdre) && (PS_ON_PIN > -1)
    SET_OUTPUT(PS_ON_PIN);
#endif
#if defined (upstream) && (defined(PS_DEFAULT_OFF) && (defined(PS_ON_PIN) && PS_ON_PIN > -1 &)
    WRITE(PS_ON_PIN, PS_ON_ASLEEP);
#endif
#if defined (upstream) && ((defined(PS_ON_PIN) && PS_ON_PIN > -1 && )!defined(PS_DEFAULT_OFF) ) || defined (drsdre) && (PS_ON_PIN > -1)
...
#if defined (upstream) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (drsdre) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) )
    SERIAL_ECHO_START;
...
#if defined (upstream) && EXTRUDERS > 1 || defined (drsdre) && EXTRUDERS > 1
            if
            (tmp_extruder != active_extruder) {
...
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) ) || defined (drsdre) && EXTRUDERS > 1
...
//sent position to plan_set_position();
                plan_set_position(delta[X_AXIS], delta[Y_AXIS], delta[Z_AXIS],current_position[E_AXIS]);
#endif
#if defined (upstream) && (EXTRUDERS > 1 && !defined (DELTA) ) || defined (drsdre) && EXTRUDERS > 1
                plan_set_position(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS]);
#endif
...
void get_arc_coordinates
() {
#if defined (upstream) && defined (SF_ARC_FIX) || defined (drsdre) && defined (SF_ARC_FIX)
...
//DUAL_X_CARRIAGE
#endif
#if defined (upstream) && (! (defined DELTA || defined SCARA)) || defined (drsdre)
...
#endif
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (drsdre) && defined (CONTROLLERFAN_PIN)
...
#endif
#if defined (upstream) && defined (EXTRUDER_RUNOUT_PREVENT) || defined (drsdre) && defined (EXTRUDER_RUNOUT_PREVENT)
    if
...
;
#if defined (upstream) && defined (FAST_PWM_FAN) || defined (drsdre) && defined (FAST_PWM_FAN)
