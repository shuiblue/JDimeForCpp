...
#include "Marlin.h"
    ...
    #include "Servo.h"
#endif
#if defined (upstream) && (defined(DIGIPOTSS_PIN) && DIGIPOTSS_PIN > -1) || defined (indi-3DR) && DIGIPOTSS_PIN > -1
    #include <SPI.h>
#endif
#if defined (upstream)
...
#endif
#if defined (indi-3DR) && defined (FWRETRACT)
...
#endif
#if defined (upstream) && !defined (DELTA) || defined (indi-3DR)
...
#endif
#if defined (upstream) && !defined (SDSUPPORT) || defined (indi-3DR)
extern "C"
{
...
() {
    ...
    SET_INPUT(KILL_PIN);
#endif
#if defined (indi-3DR) &&  KILL_PIN>-1 )
    pinMode(KILL_PIN,INPUT);
#endif
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1) || defined (indi-3DR) &&  KILL_PIN>-1 )
    WRITE(KILL_PIN,HIGH);
#endif
}
#endif
...
void setup_photpin
() {
#if defined (upstream) && (defined(PHOTOGRAPH_PIN) && PHOTOGRAPH_PIN > -1) || defined (indi-3DR) && ((PHOTOGRAPH_PIN > -1) && defined (PHOTOGRAPH_PIN) )
...
() {
#if defined (upstream) && (defined(SUICIDE_PIN) && SUICIDE_PIN > -1) || defined (indi-3DR) && (defined (SUICIDE_PIN) && (SUICIDE_PIN> -1) )
...
#if defined (upstream) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) ) || defined (indi-3DR) && (defined (STRING_CONFIG_H_AUTHOR) && defined (STRING_VERSION_CONFIG_H) )
    SERIAL_ECHO_START;
...
#endif
#if defined (indi-3DR) && defined (SDSUPPORT)
                SERIAL_PROTOCOLLNPGM(MSG_OK);
#endif
            } else {
                card.closefile();
...
void get_arc_coordinates
() {
#if defined (upstream) && defined (SF_ARC_FIX) || defined (indi-3DR) && defined (SF_ARC_FIX)
...
//DUAL_X_CARRIAGE
#endif
#if defined (upstream) && (! (defined DELTA || defined SCARA))
...
#endif
#if defined (upstream) && (defined(CONTROLLERFAN_PIN) && CONTROLLERFAN_PIN > -1) || defined (indi-3DR) && defined (CONTROLLERFAN_PIN)
...
//Not a time critical function, so we only check every 2500ms
    ...
    (!READ(X_ENABLE_PIN) || !READ(Y_ENABLE_PIN) || !READ(Z_ENABLE_PIN) || (soft_pwm_bed > 0)
            ...
            || !READ(E0_ENABLE_PIN))
#endif
#if defined (indi-3DR) && defined (CONTROLLERFAN_PIN)
...
// -------------------------------------------------------------------------------
    ...
    ( 0 == READ(KILL_PIN) ) {
        ...
        killCount++;
#endif
#if defined (indi-3DR) &&  KILL_PIN>-1 )kill();
#endif
    }
#if defined (upstream) && (defined(KILL_PIN) && KILL_PIN > -1)
    else if (killCount > 0) {
...
#endif
#if defined (upstream) && defined (EXTRUDER_RUNOUT_PREVENT) || defined (indi-3DR) && defined (EXTRUDER_RUNOUT_PREVENT)
    if
...
#endif
#if defined (indi-3DR) && defined (EXTRUDER_RUNOUT_PREVENT)
            plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS],
...
;
#if defined (upstream) && defined (FAST_PWM_FAN) || defined (indi-3DR) && defined (FAST_PWM_FAN)
