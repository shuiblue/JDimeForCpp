 ...
 */
    ...
    */
...
#endif
#if defined (A) && defined (NUM_SERVOS)
    ...
    #include "Servo.h"
#endif
#if defined (B) && defined (NUM_SERVOS)
    #include "servo.h"
#endif
#if defined (A) && defined (NUM_SERVOS)
...
static inline void handle_interrupts(timer16_Sequence_t timer, volatile uint16_t *TCNTn, volatile uint16_t* OCRnA) {
    ...
    //------------------------------------------------------------------------------
#endif
#if defined (A) && (defined (NUM_SERVOS) && !defined (WIRING) )
...
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer1) && !defined (WIRING) )
...
#endif
#if defined (B) && (defined (NUM_SERVOS) && defined (_useTimer1) )

oid HANDLER_FOR_TIMER1(void) {
...
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer3) && !defined (WIRING) )
    handle_interrupts(_timer3, &TCNT3, &OCR3A);
#endif
#if defined (B) && (defined (NUM_SERVOS) && defined (_useTimer3) )
    oid HANDLER_FOR_TIMER3(void) {
...
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer4) && !defined (WIRING) )
        handle_interrupts(_timer4, &TCNT4, &OCR4A);
#endif
#if defined (B) && (defined (NUM_SERVOS) && defined (_useTimer5) )
        oid HANDLER_FOR_TIMER5(void) {
...
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer5) && !defined (WIRING) )
            handle_interrupts(_timer5, &TCNT5, &OCR5A);
#endif
#if defined (B) && defined (NUM_SERVOS)
            tatic void _initISR(Tc *tc, uint32_t channel, uint32_t id, IRQn_Type irqn) {
...
#endif
#if defined (B) && (defined (NUM_SERVOS) && defined (_useTimer2) )
                    if (timer == _timer2)
