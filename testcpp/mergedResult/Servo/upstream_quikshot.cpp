...
#endif
#if defined (A) && defined (NUM_SERVOS) || defined (B) && defined (NUM_SERVOS)
...
#endif
#if defined (A) && (defined (NUM_SERVOS) && !defined (WIRING) ) || defined (B) && (defined (NUM_SERVOS) && !defined (WIRING) )
    // Wiring pre-defines signal handlers so don't define any if compiling for the Wiring platform
    // Interrupt handlers for Arduino
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer1) && !defined (WIRING) ) || defined (B) && (defined (NUM_SERVOS) && defined(_useTimer1) && !defined (WIRING) )
    handle_interrupts(_timer1, &TCNT1, &OCR1A);
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer3) && !defined (WIRING) ) || defined (B) && (defined (NUM_SERVOS) && defined(_useTimer3) && !defined (WIRING) )
    handle_interrupts(_timer3, &TCNT3, &OCR3A);
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer4) && !defined (WIRING) ) || defined (B) && (defined (NUM_SERVOS) && defined(_useTimer4) && !defined (WIRING) )
    handle_interrupts(_timer4, &TCNT4, &OCR4A);
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(_useTimer5) && !defined (WIRING) ) || defined (B) && (defined (NUM_SERVOS) && defined(_useTimer5) && !defined (WIRING) )
...
#if defined (A) && (defined (NUM_SERVOS) && defined (_useTimer1) ) || defined (B) && (defined (NUM_SERVOS) && defined (_useTimer1) )
    if
    (timer == _timer1) {
        TCCR1A = 0;
...
#if defined (A) && (defined (NUM_SERVOS) && (defined(__AVR_ATmega8__)|| defined(__AVR_ATmega128__) && )defined (_useTimer1) ) || defined (B) && (defined (NUM_SERVOS) && (defined(__AVR_ATmega8__)|| defined(__AVR_ATmega128__) && )defined (_useTimer1) )
        TIFR |= _BV(OCF1A);
...
// enable the output compare interrupt
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined(WIRING) && defined (_useTimer1) ) || defined (B) && (defined (NUM_SERVOS) && defined(WIRING) && defined (_useTimer1) )
        timerAttach(TIMER1OUTCOMPAREA_INT, Timer1Service);
#endif
    }
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined (_useTimer3) ) || defined (B) && (defined (NUM_SERVOS) && defined (_useTimer3) )
    if
    (timer == _timer3) {
        TCCR3A = 0;
// normal counting mode
...
// set prescaler of 8
        TCNT3 = 0;
// clear the timer count
#if defined (A) && (defined (NUM_SERVOS) && defined(__AVR_ATmega128__) && defined (_useTimer3) ) || defined (B) && (defined (NUM_SERVOS) && defined(__AVR_ATmega128__) && defined (_useTimer3) )
        TIFR |= _BV(OCF3A);
// clear any pending interrupts;
        ETIMSK |= _BV(OCIE3A);
// enable the output compare interrupt
...
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined (_useTimer4) ) || defined (B) && (defined (NUM_SERVOS) && defined (_useTimer4) )
    if
    (timer == _timer4) {
        TCCR4A = 0;
// normal counting mode
...
#endif
#if defined (A) && (defined (NUM_SERVOS) && defined (_useTimer5) ) || defined (B) && (defined (NUM_SERVOS) && defined (_useTimer5) )
    if
    (timer == _timer5) {
        TCCR5A = 0;
// normal counting mode
...
// Wiring
    if
    (timer == _timer1) {
#if defined (A) && (defined (NUM_SERVOS) && defined WIRING && (defined(__AVR_ATmega1281__)||defined(__AVR_ATmega2561__) &) || defined (B) && (defined (NUM_SERVOS) && defined WIRING && (defined(__AVR_ATmega1281__)||defined(__AVR_ATmega2561__) &)
        TIMSK1 &=  ~_BV(OCIE1A) ;
// disable timer 1 output compare interrupt
#endif
#if defined (A) && (defined (NUM_SERVOS) && (!defined(__AVR_ATmega1281__)||defined(__AVR_ATmega2561__) && )defined WIRING ) || defined (B) && (defined (NUM_SERVOS) && (!defined(__AVR_ATmega1281__)||defined(__AVR_ATmega2561__) && )defined WIRING )
        TIMSK &=  ~_BV(OCIE1A) ;
// disable timer 1 output compare interrupt
#endif
...
#if defined (A) && (defined (NUM_SERVOS) && (defined (ENABLE_AUTO_BED_LEVELING) && (PROBE_SERVO_DEACTIVATION_DELAY > 0) &) || defined (B) && (defined (NUM_SERVOS) && (defined (ENABLE_AUTO_BED_LEVELING) && (PROBE_SERVO_DEACTIVATION_DELAY > 0) &)
        if
        (pin > 0)
            this->pin = pin;
        else
