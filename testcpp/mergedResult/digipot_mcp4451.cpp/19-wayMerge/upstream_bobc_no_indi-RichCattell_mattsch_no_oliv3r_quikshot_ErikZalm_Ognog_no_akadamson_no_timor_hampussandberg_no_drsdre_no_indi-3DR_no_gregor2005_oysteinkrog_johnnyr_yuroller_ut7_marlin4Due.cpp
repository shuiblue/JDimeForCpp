#if defined (upstream) || defined (bobc) || defined (mattsch) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (hampussandberg) || defined (oysteinkrog) || defined (johnnyr) || defined (yuroller) || defined (ut7) || defined (marlin4Due)
    #include "Configuration.h"
#endif
#if defined (upstream) && defined (DIGIPOT_I2C) || defined (bobc) && defined (DIGIPOT_I2C) || defined (mattsch) && defined (DIGIPOT_I2C) || defined (quikshot) && defined (DIGIPOT_I2C) || defined (ErikZalm) && defined (DIGIPOT_I2C) || defined (Ognog) && defined (DIGIPOT_I2C) || defined (hampussandberg) && defined (DIGIPOT_I2C) || defined (oysteinkrog) && defined (DIGIPOT_I2C) || defined (johnnyr) && defined (DIGIPOT_I2C) || defined (yuroller) && defined (DIGIPOT_I2C) || defined (ut7) && defined (DIGIPOT_I2C) || defined (marlin4Due) && defined (DIGIPOT_I2C)
    #include "Stream.h"
