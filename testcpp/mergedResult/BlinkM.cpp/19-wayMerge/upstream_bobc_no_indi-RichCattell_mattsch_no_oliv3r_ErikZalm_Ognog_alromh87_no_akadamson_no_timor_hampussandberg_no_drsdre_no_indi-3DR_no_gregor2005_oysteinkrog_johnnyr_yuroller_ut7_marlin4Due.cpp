#if defined (upstream) || defined (bobc) || defined (mattsch) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (oysteinkrog) || defined (johnnyr) || defined (yuroller) || defined (ut7)
/*
