#if defined (upstream) || defined (bobc) || defined (mattsch) || defined (quikshot) || defined (ErikZalm) || defined (Ognog) || defined (alromh87) || defined (hampussandberg) || defined (oysteinkrog) || defined (johnnyr) || defined (yuroller)
/*
