 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_CA_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_CA_H)
...
#endif
#if defined (upstreamBeforeMerge) && (defined (DELTA_CALIBRATION_MENU) && !defined (LANGUAGE_CA_H) ) || defined (forkBeforeMerge) && (defined (DELTA_CALIBRATION_MENU) && !defined (LANGUAGE_CA_H) )
