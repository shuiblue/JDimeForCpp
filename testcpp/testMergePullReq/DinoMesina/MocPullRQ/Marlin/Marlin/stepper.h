...
*/
#endif
#if defined (upstreamBeforeMerge) && !defined (stepper_h) || defined (forkBeforeMerge) && !defined (stepper_h)
    #define stepper_h
    #include "planner.h"
#endif
#if defined (upstreamBeforeMerge) && (EXTRUDERS > 2 && !defined (stepper_h) ) || defined (forkBeforeMerge) && (EXTRUDERS > 2 && !defined (stepper_h) )
    #define WRITE_E_STEP(v) { if(current_block->active_extruder == 2) { WRITE(E2_STEP_PIN, v); } else { if(current_block->active_extruder == 1) { WRITE(E1_STEP_PIN, v); } else { WRITE(E0_STEP_PIN, v); }}}
    #define NORM_E_DIR() { if(current_block->active_extruder == 2) { WRITE(E2_DIR_PIN, !INVERT_E2_DIR); } else { if(current_block->active_extruder == 1) { WRITE(E1_DIR_PIN, !INVERT_E1_DIR); } else { WRITE(E0_DIR_PIN, !INVERT_E0_DIR); }}}
    #define REV_E_DIR() { if(current_block->active_extruder == 2) { WRITE(E2_DIR_PIN, INVERT_E2_DIR); } else { if(current_block->active_extruder == 1) { WRITE(E1_DIR_PIN, INVERT_E1_DIR); } else { WRITE(E0_DIR_PIN, INVERT_E0_DIR); }}}
#endif
#if defined (upstreamBeforeMerge) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) && !defined (stepper_h) ) || defined (forkBeforeMerge) && (EXTRUDERS > 1 && !defined (DUAL_X_CARRIAGE) && !defined (stepper_h) )
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (stepper_h) && !EXTRUDERS > 1 ) || defined (forkBeforeMerge) && (!defined (stepper_h) && !EXTRUDERS > 1 )
    #define WRITE_E_STEP(v) WRITE(E0_STEP_PIN, v)
    #define NORM_E_DIR() WRITE(E0_DIR_PIN, !INVERT_E0_DIR)
    #define REV_E_DIR() WRITE(E0_DIR_PIN, INVERT_E0_DIR)
#endif
#if defined (upstreamBeforeMerge) && (defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && !defined (stepper_h) ) || defined (forkBeforeMerge) && (defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && !defined (stepper_h) )
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (stepper_h) && defined (ENABLE_AUTO_BED_LEVELING) ) || defined (forkBeforeMerge) && (!defined (stepper_h) && defined (ENABLE_AUTO_BED_LEVELING) )
...
#endif
#if defined (upstreamBeforeMerge) && (defined (BABYSTEPPING) && !defined (stepper_h) ) || defined (forkBeforeMerge) && (defined (BABYSTEPPING) && !defined (stepper_h) )
