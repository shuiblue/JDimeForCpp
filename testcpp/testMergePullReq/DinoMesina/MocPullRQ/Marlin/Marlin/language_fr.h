 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_FR_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_FR_H)
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (LANGUAGE_FR_H) && defined (DELTA_CALIBRATION_MENU) ) || defined (forkBeforeMerge) && (!defined (LANGUAGE_FR_H) && defined (DELTA_CALIBRATION_MENU) )
