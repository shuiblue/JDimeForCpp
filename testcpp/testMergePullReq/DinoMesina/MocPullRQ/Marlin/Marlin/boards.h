#if defined (upstreamBeforeMerge) && !defined (BOARDS_H) || defined (forkBeforeMerge) && !defined (BOARDS_H)
    #define BOARDS_H
    ...
    #define BOARD_DUEMILANOVE_328P  4
    ...
    // Megatronics v2.0
    #define BOARD_MEGATRONICS_1     702
    // Minitronics v1.0
