 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_AN_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_AN_H)
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (LANGUAGE_AN_H) && defined (DELTA_CALIBRATION_MENU) ) || defined (forkBeforeMerge) && (!defined (LANGUAGE_AN_H) && defined (DELTA_CALIBRATION_MENU) )
