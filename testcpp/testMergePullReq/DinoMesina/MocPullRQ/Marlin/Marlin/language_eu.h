 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_EU_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_EU_H)
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (LANGUAGE_EU_H) && defined (DELTA_CALIBRATION_MENU) ) || defined (forkBeforeMerge) && (!defined (LANGUAGE_EU_H) && defined (DELTA_CALIBRATION_MENU) )
