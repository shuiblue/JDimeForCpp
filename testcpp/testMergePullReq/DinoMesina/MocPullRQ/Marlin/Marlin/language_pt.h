 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_PT_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_PT_H)
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (LANGUAGE_PT_H) && defined (DELTA_CALIBRATION_MENU) ) || defined (forkBeforeMerge) && (!defined (LANGUAGE_PT_H) && defined (DELTA_CALIBRATION_MENU) )
