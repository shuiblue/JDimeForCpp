 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_NL_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_NL_H)
...
#endif
#if defined (upstreamBeforeMerge) && (defined (DELTA_CALIBRATION_MENU) && !defined (LANGUAGE_NL_H) ) || defined (forkBeforeMerge) && (defined (DELTA_CALIBRATION_MENU) && !defined (LANGUAGE_NL_H) )
