 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_IT_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_IT_H)
...
#endif
#if defined (upstreamBeforeMerge) && (defined (DELTA_CALIBRATION_MENU) && !defined (LANGUAGE_IT_H) ) || defined (forkBeforeMerge) && (defined (DELTA_CALIBRATION_MENU) && !defined (LANGUAGE_IT_H) )
