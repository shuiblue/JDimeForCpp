 ...
 */
#endif
#if defined (upstreamBeforeMerge) && !defined (LANGUAGE_FI_H) || defined (forkBeforeMerge) && !defined (LANGUAGE_FI_H)
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (LANGUAGE_FI_H) && defined (DELTA_CALIBRATION_MENU) ) || defined (forkBeforeMerge) && (!defined (LANGUAGE_FI_H) && defined (DELTA_CALIBRATION_MENU) )
