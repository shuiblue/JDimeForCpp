...
#include "Marlin.h"
#endif
#if defined (upstreamBeforeMerge) && (!defined (SdVolume_h) && defined (SDSUPPORT) ) || defined (forkBeforeMerge) && (!defined (SdVolume_h) && defined (SDSUPPORT) )
#define SdVolume_h
/**
 * \file
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (SdVolume_h) && USE_MULTIPLE_CARDS && defined (SDSUPPORT) ) || defined (forkBeforeMerge) && (!defined (SdVolume_h) && USE_MULTIPLE_CARDS && defined (SDSUPPORT) )
...
// used by SdBaseFile write to assign cache to SD location
    ...
    bool readBlock
    (uint32_t block, uint8_t* dst) {
        return sdCard_->readBlock(block, dst);
    }
    bool writeBlock
    (uint32_t block, const uint8_t* dst) {
        return sdCard_->writeBlock(block, dst);
    }
//------------------------------------------------------------------------------
// Deprecated functions  - suppress cpplint warnings with NOLINT comment
#endif
#if defined (upstreamBeforeMerge) && (!defined (SdVolume_h) && (ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) ) || defined (forkBeforeMerge) && (!defined (SdVolume_h) && (ALLOW_DEPRECATED_FUNCTIONS && !defined(DOXYGEN) && )defined (SDSUPPORT) )
  public:
