...
#include "Marlin.h"
#endif
#if defined (upstreamBeforeMerge) && (!defined (SdBaseFile_h) && defined (SDSUPPORT) ) || defined (forkBeforeMerge) && (!defined (SdBaseFile_h) && defined (SDSUPPORT) )
#define SdBaseFile_h
/**
 * \file
 ...
 */
static inline uint16_t FAT_DATE
 ...
 */
static inline uint16_t FAT_YEAR
(uint16_t fatDate) {
 ...
 */
static inline uint8_t FAT_MONTH
(uint16_t fatDate) {
 ...
 */
static inline uint16_t FAT_TIME
 ...
 */
static inline uint8_t FAT_HOUR
(uint16_t fatTime) {
    return fatTime >> 11;
}
 ...
 */
static inline uint8_t FAT_MINUTE
(uint16_t fatTime) {
 ...
 */
static inline uint8_t FAT_SECOND
(uint16_t fatTime) {
