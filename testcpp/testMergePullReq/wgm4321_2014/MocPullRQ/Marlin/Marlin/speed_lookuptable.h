#if defined (upstreamBeforeMerge) && !defined (SPEED_LOOKUPTABLE_H) || defined (forkBeforeMerge) && !defined (SPEED_LOOKUPTABLE_H)
    #define SPEED_LOOKUPTABLE_H
    #include "Marlin.h"
#endif
#if defined (upstreamBeforeMerge) && (!defined (SPEED_LOOKUPTABLE_H) && F_CPU == 16000000 ) || defined (forkBeforeMerge) && (!defined (SPEED_LOOKUPTABLE_H) && F_CPU == 16000000 )
...
#endif
#if defined (upstreamBeforeMerge) && (F_CPU == 20000000 && !defined (SPEED_LOOKUPTABLE_H) ) || defined (forkBeforeMerge) && (F_CPU == 20000000 && !defined (SPEED_LOOKUPTABLE_H) )
const uint16_t speed_lookuptable_fast[256][2] PROGMEM = {
