...
#endif
#if defined (upstreamBeforeMerge) && defined (ADVANCE) || defined (forkBeforeMerge) && defined (ADVANCE)
...
#endif
#if defined (upstreamBeforeMerge) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) || defined (forkBeforeMerge) && defined (ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED)
    bool abort_on_endstop_hit = false;
#endif
#if defined (upstreamBeforeMerge) && defined (MOTOR_CURRENT_PWM_XY_PIN) || defined (forkBeforeMerge) && defined (MOTOR_CURRENT_PWM_XY_PIN)
...
() {
    if
    ( endstop_x_hit || endstop_y_hit || endstop_z_hit) {
        SERIAL_ECHO_START;
        ...
        endstop_y_hit=false;
        endstop_z_hit=false;
#if defined (upstreamBeforeMerge) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT)) || defined (forkBeforeMerge) && (defined(ABORT_ON_ENDSTOP_HIT_FEATURE_ENABLED) && defined(SDSUPPORT))
        if
...
FORCE_INLINE unsigned short calc_timer
...
#if defined (upstreamBeforeMerge) && defined (Z_LATE_ENABLE) || defined (forkBeforeMerge) && defined (Z_LATE_ENABLE)
        if
