...
#endif
#if defined (upstreamBeforeMerge) && !defined (planner_h) || defined (forkBeforeMerge) && !defined (planner_h)
    #define planner_h
    #include "Marlin.h"
#endif
#if defined (upstreamBeforeMerge) && (!defined (planner_h) && defined (ENABLE_AUTO_BED_LEVELING) ) || defined (forkBeforeMerge) && (!defined (planner_h) && defined (ENABLE_AUTO_BED_LEVELING) )
    #include "vector_3.h"
#endif
#if defined (upstreamBeforeMerge) && !defined (planner_h) || defined (forkBeforeMerge) && !defined (planner_h)
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (planner_h) && defined (AUTOTEMP) ) || defined (forkBeforeMerge) && (!defined (planner_h) && defined (AUTOTEMP) )
...
#endif
#if defined (upstreamBeforeMerge) && (!defined (planner_h) && defined (PREVENT_DANGEROUS_EXTRUDE) ) || defined (forkBeforeMerge) && (!defined (planner_h) && defined (PREVENT_DANGEROUS_EXTRUDE) )
